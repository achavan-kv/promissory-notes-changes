						...
						<xs:schema targetNamespace="http://www.bluebridgeltd.com/cosacs/Order/2015/schema.xsd" elementFormDefault="qualified"
							...
							<xs:complexType name="Item" >
								<xs:sequence>
									...
									<xs:element name="Level_1" minOccurs="0" maxOccurs="1">
										<xs:simpleType>
											<xs:restriction base="xs:string">
									...
									<xs:element name="Level_2" minOccurs="0" maxOccurs="1" type="xs:short"/>
									<xs:element name="Level_3" minOccurs="0" maxOccurs="1" >
										<xs:simpleType>
											<xs:restriction base="xs:string">
