...
IF EXISTS(SELECT * FROM sys.columns 
              WHERE [name] = N'Department' AND [object_id] = OBJECT_ID(N'Sales.OrderItem'))BEGIN

ALTER TABLE Sales.OrderItem
ALTER COLUMN Department varchar(32)

END
GO

IF EXISTS(SELECT * FROM sys.columns 
              WHERE [name] = N'Class' AND [object_id] = OBJECT_ID(N'Sales.OrderItem'))BEGIN

ALTER TABLE Sales.OrderItem
ALTER COLUMN Class varchar(32)
...
WHERE Id IN (21, 22, 23) AND [Binding] = 'Sales.Order'
GO