...
UPDATE Hub.Queue SET [Schema] = N'<xs:schema targetNamespace="http://www.bluebridgeltd.com/cosacs/Order/2015/schema.xsd" elementFormDefault="qualified"
    ...
    <xs:element name="Order">
        <xs:complexType>
            <xs:sequence>
                ...
                <xs:element name="OriginalBranchNo" minOccurs="0" maxOccurs="1" type="xs:short"/>
                ...
                <xs:element name="CashAndGoAccountNo" minOccurs="1" maxOccurs="1">
                    <xs:simpleType>
                        <xs:restriction base="xs:string">
    ...
    <xs:complexType name="Item" >
        <xs:sequence>
            ...
            <xs:element name="IsClaimed" minOccurs="1" maxOccurs="1" type="xs:boolean"/>
            <xs:element name="IsReplacement" minOccurs="1" maxOccurs="1" type="xs:boolean"/>
            <xs:element name="SalePrice" minOccurs="1" maxOccurs="1" type="xs:decimal"/>
            <xs:element name="SaleTaxAmount" minOccurs="1" maxOccurs="1" type="xs:decimal"/>
        </xs:sequence>
    </xs:complexType>
    ...
    <xs:complexType name="Payment">
        <xs:sequence>
            ...
            <xs:element name="ChequeNo" minOccurs="0" maxOccurs="1">
                <xs:simpleType>
                    <xs:restriction base="xs:string">
                        <xs:maxLength value="16" />
                    </xs:restriction>
