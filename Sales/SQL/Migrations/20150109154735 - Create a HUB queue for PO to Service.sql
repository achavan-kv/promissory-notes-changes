...
-- 
IF NOT EXISTS(SELECT Id FROM Hub.Queue WHERE Id = 21) 
BEGIN	
		...
		<xs:schema targetNamespace="http://www.bluebridgeltd.com/cosacs/Order/2015/schema.xsd" elementFormDefault="qualified"
			...
			<xs:complexType name="Item" >
				<xs:sequence>
					...
					<xs:element name="WarrantyLengthMonths" minOccurs="0" maxOccurs="1" type="xs:unsignedByte" nillable="true"/>
					<xs:element name="WarrantyEffectiveDate" minOccurs="0" maxOccurs="1" type="xs:date" nillable="true"/>
					<xs:element name="WarrantyContractNo" minOccurs="0" maxOccurs="1" nillable="true">
						<xs:simpleType>
							<xs:restriction base="xs:string">
					...
					<xs:element name="WarrantyTypeCode" minOccurs="0" maxOccurs="1" nillable="true">
						<xs:simpleType>
							<xs:restriction base="xs:string">
					...
					<xs:element name="WarrantyLinkId" minOccurs="0" maxOccurs="1" type="xs:int" nillable="true"/>
					...
					<xs:element name="ReturnReason" minOccurs="0" maxOccurs="1" nillable="true">
						<xs:simpleType>
							<xs:restriction base="xs:string">
								<xs:maxLength value="32" />
							</xs:restriction>
		...
		null, 
		'Order.xsd', 
		'/Cosacs/Service/InstallationSubscriber/', 
		'POST' )
