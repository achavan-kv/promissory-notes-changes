...
namespace STL.PL.WCache {
    ...
    public partial class Cache : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public Cache() {
            this.Url = global::STL.PL.Properties.Settings.Default.Courts_NET_PL_Cache_Cache;
        ...
        public System.Nullable<System.DateTime> Get(string key) {
        ...
        /// <remarks/>
        public System.IAsyncResult BeginGet(string key, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("Get", new object[] {
                        key}, callback, asyncState);
        }
        
        /// <remarks/>
        public System.Nullable<System.DateTime> EndGet(System.IAsyncResult asyncResult) {
