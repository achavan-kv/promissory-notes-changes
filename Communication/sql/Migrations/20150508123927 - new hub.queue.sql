...
<xs:schema targetNamespace="http://www.bluebridgeltd.com/cosacs/2012/schema.xsd"
    ...
    <xs:element name="MailMessage">
        <xs:complexType>
            <xs:sequence>
                ...
                <xs:element name="TemplateId"  minOccurs="0" maxOccurs="1" type="xs:int" ></xs:element>
    ...
    <xs:complexType name="Mail">
        <xs:sequence>
            ...
            <xs:element name="TemplateId"  maxOccurs="1" nillable="true" type="xs:int" ></xs:element>
            <xs:element name="OverrideUnsubscribe" maxOccurs="1" nillable="true" type="xs:boolean"></xs:element>
...
(  
	24,
    N'Cosacs.Communication.SendMail',
	@schema,
	'MailMessage.xsd',
    '/Communication/api/SendMails',
    'POST'
)