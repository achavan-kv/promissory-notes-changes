...
{
	/// <summary>
	/// Summary description for AgreementXML.
	/// </summary>
	
	public class AgreementXML : PrintXMLClient
	{
        //public AgreementXML(string country)
        //{
        //    this.XmlTemplate = XMLTemplates.AgreementXML;
        //    this.Country = country;
        //    this.SetXsltPath("Agreement.xslt");
        //}

        //CR 440 - Capability to use a different xslt file as required
        public AgreementXML(string country, string xsltFilename)
        {
            this.XmlTemplate = XMLTemplates.AgreementXML;
