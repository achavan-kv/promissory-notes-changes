namespace Blue.Cosacs.Merchandising.Publishers
{
    ...
    [TestFixture]
    public class StockAdjustmentPublisherTests
    {
        private Fixture fixture;
        private IStockAdjustmentPublisher publisher;
        private MockGenericPublisher<StockAdjustmentMessage> basePublisher;
        ...
        public void SetUp()
        {
            ...
            basePublisher = new MockGenericPublisher<StockAdjustmentMessage>();

            publisher = new StockAdjustmentPublisher(basePublisher, mockProductRepo.Object);
        }

        private List<StockAdjustmentProductViewModel> GenerateProducts()
        {
            var productFixture = fixture.Build<StockAdjustmentProductViewModel>()
            ...
            productFixture.Add(fixture.Build<StockAdjustmentProductViewModel>()
        ...
        public void PublishCreated_NoProductMessages_ShouldError()
        {
            var productFixture = fixture.Build<StockAdjustmentProductViewModel>()
               .With(x => x.ProductId, 2)
               .Create();
            Assert.Catch(() => publisher.PublishCreated(new StockAdjustmentViewModel() { Products = { productFixture } }));
        }
        ...
        public void PublishCreated_Message_ShouldAggregateCount()
        {
            ...
            publisher.PublishCreated(new StockAdjustmentViewModel() { Products = productFixture });
        ...
        public void PublishCreated_Message_ShouldHaveCorrectType()
        {
            var productFixture = GenerateProducts();
            publisher.PublishCreated(new StockAdjustmentViewModel() { Products = productFixture });
            Assert.AreEqual("Merchandising.StockAdjustmentCreated", basePublisher.Routing);
        }
    }
}