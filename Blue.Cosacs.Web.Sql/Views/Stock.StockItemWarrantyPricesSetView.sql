IF OBJECT_ID('Stock.StockItemWarrantyPricesSetView') IS NOT NULL
	DROP VIEW Stock.StockItemWarrantyPricesSetView
GO 

CREATE VIEW Stock.StockItemWarrantyPricesSetView
AS
