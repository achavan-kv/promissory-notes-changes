ALTER TABLE dbo.StoreCard ADD
	FixedRate float(53) NULL,
	RateId int NULL
GO
...
IF EXISTS(SELECT * FROM dbo.StoreCard)
	 EXEC('INSERT INTO dbo.Tmp_StoreCard (Id, Number, Name, IssueYear, IssueMonth, ExpirationYear, ExpirationMonth)
		SELECT Id, Number, Name, IssueYear, IssueMonth, ExpirationYear, ExpirationMonth FROM dbo.StoreCard WITH (HOLDLOCK TABLOCKX)')
GO
