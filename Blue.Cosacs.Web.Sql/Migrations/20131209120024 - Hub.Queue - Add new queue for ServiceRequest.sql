...
(Id, [Binding], [Schema])
values (15, 'Cosacs.Service.Detail', '<xs:schema targetNamespace="http://www.bluebridgeltd.com/cosacs/2012/schema.xsd"
        ...
        <xs:complexType>
            <xs:all>
                ...
                <xs:element name="Charges">
                    <xs:complexType>
                        <xs:sequence>
                            <xs:element name="Charge" minOccurs="1" maxOccurs="unbounded" type="Charge"/>
                        </xs:sequence>
                    </xs:complexType>
                </xs:element>
                <xs:element name="Parts">
                    <xs:complexType>
                        <xs:sequence>
                            <xs:element name="Part" minOccurs="1" maxOccurs="unbounded" type="ServicePart"/>
                        </xs:sequence>
                    </xs:complexType>
                </xs:element>
            </xs:all>
