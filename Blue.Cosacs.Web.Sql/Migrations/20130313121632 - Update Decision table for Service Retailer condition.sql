...
'{
  "conditions": [
    ...
    {
      "expression": "(this.serviceRequest.ResolutionPrimaryCharge === ''Deliverer'' || this.serviceRequest.ResolutionPrimaryCharge === ''Customer'') &&  this.serviceRequest.RepairTotal > 0"
    }
  ],
  "actions": [
    {
    ...
    {
      "expression": "chargeTos(this, [''Customer'',''Installation Charge Account'']);"
    },
    {
