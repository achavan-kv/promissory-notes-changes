...
UPDATE Hub.Queue
SET [Schema] = CAST('<xs:schema xmlns="http://www.bluebridgeltd.com/cosacs/2012/schema.xsd" xmlns:mstns="http://www.bluebridgeltd.com/cosacs/2012/schema.xsd" xmlns:xs="http://www.w3.org/2001/XMLSchema" targetNamespace="http://www.bluebridgeltd.com/cosacs/2012/schema.xsd" elementFormDefault="qualified">
  ...
  <xs:complexType name="Item">
    <xs:sequence>
      ...
      <xs:element name="Id" minOccurs="0" maxOccurs="1" nillable ="true" type="xs:int" />
  ...
  <xs:complexType name="Warranty">
    <xs:all>
      ...
      <xs:element name="WarrantyContractId" nillable="true" minOccurs="0" maxOccurs="1" type="xs:int" />
    </xs:all>
  </xs:complexType>
  ...
  <xs:element name="ServicePayment">
    <xs:complexType>
      <xs:all>
        ...
        <xs:element name="ServiceBranch" minOccurs="1" maxOccurs="1" type="xs:int" nillable="true" />
      </xs:all>
    </xs:complexType>
  </xs:element>
...
WHERE 
	Binding = 'Cosacs.Service.WarrantyServiceCompleted'