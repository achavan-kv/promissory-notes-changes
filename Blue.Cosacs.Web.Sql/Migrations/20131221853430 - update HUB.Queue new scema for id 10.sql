...
UPDATE HUB.Queue
SET [Schema] = CAST('<?xml version="1.0" encoding="utf-8"?>
<xs:schema targetNamespace="http://www.bluebridgeltd.com/cosacs/2012/schema.xsd"
    ...
    <xs:element name="SalesItemReturn">
        <xs:complexType>
            <xs:sequence>
                <xs:element name="LineItemIdentifier" minOccurs="1" maxOccurs="1" type="xs:int"/>
                <xs:element name="SaleBranch" minOccurs="1" maxOccurs="1" type="xs:short"/>
                <xs:element name="Item" minOccurs="0" maxOccurs="1" type="Item"/>
            </xs:sequence>
        </xs:complexType>
    </xs:element>
