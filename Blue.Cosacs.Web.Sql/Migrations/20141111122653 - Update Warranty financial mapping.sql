...
VALUES
	...
	('Credit', 'PCE', 1, 1, 1, 'Sale', '5112', 'REP'),
	('Credit', 'PCE', -1, 1, 1, 'Sale', '1301', 'REP'),
	('*', 'PCE', 1, 1, 1, 'Cost', '2910', 'COW'),
	('*', 'PCE', -1, 1, 1, 'Cost', '6012', 'COW'),
	('Credit', 'PCE', 1, 1, 1, 'Sale', '1301', 'CRE'),
	('Credit', 'PCE', -1, 1, 1, 'Sale', '5112', 'CRE'),
	('Cash', 'PCE', 1, 1, 1, 'Sale', '5212', 'REP'),
	('Cash', 'PCE', -1, 1, 1, 'Sale', '1301', 'REP'),
	('Cash', 'PCE', 1, 1, 1, 'Sale', '1301', 'CRE'),
	('Cash', 'PCE', -1, 1, 1, 'Sale', '5212', 'CRE'),
	('Credit', 'PCF', 1, 1, 1, 'Sale', '5182', 'REP'),
	('Credit', 'PCF', -1, 1, 1, 'Sale', '1301', 'REP'),
	('*', 'PCF', 1, 1, 1, 'Cost', '2910', 'COW'),
	('*', 'PCF', -1, 1, 1, 'Cost', '6082', 'COW'),
	('Credit', 'PCF', 1, 1, 1, 'Sale', '1301', 'CRF'),
	('Credit', 'PCF', -1, 1, 1, 'Sale', '5182', 'CRF'),
	('Cash', 'PCF', 1, 1, 1, 'Sale', '5282', 'REP'),
	('Cash', 'PCF', -1, 1, 1, 'Sale', '1301', 'REP'),
	('Cash', 'PCF', 1, 1, 1, 'Sale', '1301', 'CRF'),
	('Cash', 'PCF', -1, 1, 1, 'Sale', '5282', 'CRF')