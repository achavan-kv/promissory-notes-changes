...
<xs:schema targetNamespace="http://www.bluebridgeltd.com/cosacs/2012/schema.xsd" elementFormDefault="qualified" xmlns="http://www.bluebridgeltd.com/cosacs/2012/schema.xsd" xmlns:mstns="http://www.bluebridgeltd.com/cosacs/2012/schema.xsd" xmlns:xs="http://www.w3.org/2001/XMLSchema">
    ...
    <xs:complexType name="Warranty">
        <xs:sequence>
            ...
            <xs:element name="Department" minOccurs="1" maxOccurs="1" nillable="true">
                <xs:simpleType>
                    <xs:restriction base="xs:string">
            ...
            <xs:element name="TypeCode" minOccurs="1" maxOccurs="1" type="xs:string" />
            ...
            <xs:element name="EffectiveDate" minOccurs="1" maxOccurs="1" type="xs:dateTime" />
            <xs:element name="RedeemContractNumber" minOccurs="1" maxOccurs="1">
                <xs:simpleType>
                    <xs:restriction base="xs:string">
                        <xs:maxLength value ="10"/>
                    </xs:restriction>
            ...
            <xs:element name="ReLinkContractNo" minOccurs="1" maxOccurs="1">
                <xs:simpleType>
                    <xs:restriction base="xs:string">
                        <xs:maxLength value ="10"/>
                    </xs:restriction>
            ...
            <xs:element name="WarrantyDeliveredOn" minOccurs="0" maxOccurs="1" type="xs:dateTime" nillable="true"/>
        </xs:sequence>
    </xs:complexType>
    <xs:complexType name="Item">
        <xs:sequence>
            ...
            <xs:element name="TotalQuantity" minOccurs="1" maxOccurs="1" nillable="true" type="xs:int" />
        </xs:sequence>
    </xs:complexType>
    ...
    <xs:element name="SalesOrderCancel">
        <xs:complexType>
            <xs:sequence>
                ...
                <xs:element name="ItemQuantity" minOccurs="1" maxOccurs="1" nillable="true" type="xs:int" />
                <xs:element name="IsRepossessed" minOccurs="0" maxOccurs="1" default="false" nillable="true" type="xs:boolean" />
				<xs:element name="CancelledDate" minOccurs="0" maxOccurs="1" type="xs:date" />
            </xs:sequence>
        </xs:complexType>
    </xs:element>
...
WHERE binding = 'Warranty.Sale.Cancel'