...
DECLARE @xml XML = CAST('<xs:schema targetNamespace="http://www.bluebridgeltd.com/cosacs/2012/schema.xsd" elementFormDefault="qualified" xmlns="http://www.bluebridgeltd.com/cosacs/2012/schema.xsd" xmlns:mstns="http://www.bluebridgeltd.com/cosacs/2012/schema.xsd" xmlns:xs="http://www.w3.org/2001/XMLSchema">
...
IF EXISTS (SELECT * FROM Hub.[Queue] WHERE id = 16)
	UPDATE Hub.[Queue] 
	SET SubscriberSqlConnectionName = 'Default', [Schema] = @xml
	WHERE id = 16
ELSE
	...
	VALUES
	(16, 'Warranty.Sale.Submit', @xml, NULL, NULL, 'Default', 'Financial.ProcessMessageWarranty')
