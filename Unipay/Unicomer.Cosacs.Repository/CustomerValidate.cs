...
Description of Changes: 
 1. pass parameter "LastName_IN" and "DOB_IN" to call procedure "ValidateCustomer". 
 2. Declare class variables "LastName_IN" and "DOB_IN".
 3. Add "MiddleName" parameter in call of stored procedure "CustomerDetailsSave" to save middle name.
*/
...
namespace Unicomer.Cosacs.Repository
{
    ...
    public partial class CustomerValidate : Blue.Transactions.Command<ContextBase>
    {
        public CustomerValidate() : base("dbo.ValidateCustomer")
        {
            ...
            base.AddInParameter("@LastName_IN", DbType.String);
            base.AddInParameter("@DOB_IN", DbType.DateTime);
        }
    }
    ...
    partial class CustomerValidate
    {
        ...
        public void Fill(DataSet ds, string _IdNumber, string _IdType, string _PhNumber, string _LastName, DateTime _DateOfBirth)
        {
    ...
    public partial class CustomerInsertRepository : Blue.Transactions.Command<ContextBase>
    {
        public CustomerInsertRepository() : base("dbo.CustomerDetailsSave")
        {
            ...
            base.AddInParameter("@MiddleName", DbType.String);
