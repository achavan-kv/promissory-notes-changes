angular.module('blue.config', []).value('blueConfig', {});
angular.module('blue', ['blue.config']);

angular.module('blue')

	.directive('timePicker', function ($timeout, blueConfig) {
	'use strict';
	...
	return {
		...
		link: function postLink(scope, element, attrs, controller) {
			...
			element.timepicker(blueConfig.timepicker || {});
