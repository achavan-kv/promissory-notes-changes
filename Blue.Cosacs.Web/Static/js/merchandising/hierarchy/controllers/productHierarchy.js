                ...
                .success(function (data) {
                    levelKeys = _.keys(data.levels),
                        productHierarchyScope = {
                            ...
                            productDepartmentTemplate: url.resolve('static/js/merchandising/hierarchy/Templates/ProductDepartment.html'),
                            productCategoryTemplate: url.resolve('static/js/merchandising/hierarchy/Templates/ProductCategory.html'),
                            productCategoryMultipleTemplate: url.resolve('static/js/merchandising/hierarchy/Templates/ProductCategoryMultiple.html'),
                            productClassTemplate: url.resolve('static/js/merchandising/hierarchy/Templates/ProductClass.html'),
