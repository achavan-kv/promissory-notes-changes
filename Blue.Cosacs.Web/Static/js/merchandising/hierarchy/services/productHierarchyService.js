    ...
    function (_, angular, url) {
        ...
        var productHierarchySrv = function ($http, $q) {
            ...
            $http.get(url.resolve('/Stock/Catalogue/GetProductRelationsData')).then(function (result) {
                var cats = getAllCategories(productItem, result);
            ...
            function getHierarchy() {
                ...
                $http.get('/Merchandising/Hierarchy/GetHierarchy')
            ...
            function getHierarchyLevel(levelId) {
                var request = $http.get(url.resolve('/Merchandising/Hierarchy/Get?levelId=' + levelId));

                return (request
                    .then(function(response){
                        return transformTags(response.data.data[0]).value;
                    }));
            }

            function transformTags(level) {
