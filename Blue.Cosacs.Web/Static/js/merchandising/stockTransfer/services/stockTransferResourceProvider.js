...
function (angular) {
    ...
    return function ($q, $resource, apiResourceHelper, pageHelper) {
        var that = this,
            ...
            resource = apiResourceHelper.createResource('Merchandising/StockTransfer/:id', { id: '@id' }, actions),
            searchResource = apiResourceHelper.createResource('Merchandising/StockTransfer/Search/:id', { id: '@id' }, actions);
