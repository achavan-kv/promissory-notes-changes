...
function BodyOnResize()
{
	...
	if ( !parent.frames["mctoolbar"].document.getElementById( "AccordionTitle" ) ||
    ...
    parent.frames["mctoolbar"].document.getElementById( "AccordionTitle" ).style.width = Math.max( FMCGetClientWidth( window, true ), 0 ) + "px";
    SetIFrameHeight();
}
...
function SetActiveIFrame( id, title )
{
	...
	if ( gInit )
	{
		parent.frames["mctoolbar"].document.getElementById( "AccordionTitle" ).firstChild.nodeValue = title;
	}
