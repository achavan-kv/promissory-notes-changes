    ...
    <div style="position:relative">
      ...
      <div style="position:relative">
        ...
        <div class="SmallPrint" style="LEFT: 0.5cm; WIDTH: 18cm; POSITION: absolute; TOP: 1cm; HEIGHT: 18cm; font-size: 7.5pt" align="justify">
          ...
          <br />
          <br />
            2.	When the total amount paid under Clause 1 (a) and (b) hereof shall equal the total amount of the Hire Purchase price shown in the Schedule hereto, the Articles shall become the sole and absolute property of the Hirer. The Hirer may at any time during the continuance of the hiring, purchase the Articles by payment to the Owners of an amount which together with all previous payments for hire and the amount paid for the option to purchase equals the agreed value of the whole of the Articles, but unless and until such payment has been made in full, the Articles shall remain the property of the Owners, and the Hirer shall keep the goods specified in the schedule in good condition and shall be responsible for all loss or damage however occasioned (fair wear and tear accepted).
            <br />
          <br />
          ...
          of the monthly service charge, respectively, relates to the purchase of insurance on an installment basis by the customer from
          Guardian General Insurance Limited under Master Policy NO GL-50000247.
          <ul style="margin-top: 4px; margin-bottom: 5px;">
            <li>
              In the event of the customer's death, the customer becoming disabled or the goods being destroyed by
