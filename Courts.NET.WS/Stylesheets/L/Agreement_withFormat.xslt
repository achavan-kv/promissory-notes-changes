...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="HEADER">
		<table width="700" border="0" cellspacing="10">
			...
			<tr>
				<td>On the <xsl:value-of select="DATE" /> <b> Unicomer Saint Lucia Limited, registered office, Chaussee Road, Castries St. Lucia</b>  ("the Owner") agrees to supply the goods described below</td>
			</tr>
			<tr>
				<td> on Hire Purchase to <xsl:value-of select="NAME" />, <xsl:value-of select="ADDR1" />, <xsl:value-of select="ADDR2" />, <xsl:value-of select="ADDR3" />, <xsl:value-of select="POSTCODE" /> ("the Hirer").</td>
			</tr>
			...
			<tr>
			    <td>
			        ...
			        <table cellpadding="2" width="100%" style="border:1px solid black;border-collapse:collapse;">
			           <tr>
			                <td align="center" style="border-right:1px solid black;border-bottom:1px solid black;"><b>Quantity</b></td>
			                <td align="center" style="border-right:1px solid black;border-bottom:1px solid black;"><b>Description of Goods</b></td>
			                <td align="center" style="border-bottom:1px solid black;width:100px;"><b>Price</b></td>
			           </tr>
	...
	<xsl:template match="LINEITEM">
		...
		<xsl:if test="$addTo = 'True'">
				 <tr>
			         	<td style="border-right:1px solid black;"><xsl:value-of select="QUANTITY" /></td>
		...
		<xsl:if test="$addTo != 'True'">
				<tr>
			        <td style="border-right:1px solid black;" align="center"><xsl:value-of select="QUANTITY" /></td>
					<td style="border-right:1px solid black;padding-left:4px;"><xsl:value-of select="DESC" /></td>
					<td style="padding-right:4px;" align="right"><xsl:value-of select="VALUE" /></td>
			    </tr>
				<tr>
			        <td style="border-right:1px solid black;"></td>
					<td style="border-right:1px solid black;padding-left:4px;"><xsl:value-of select="TRIM" /></td>
					<td></td>
			    </tr>
				<tr>
			        <td style="border-right:1px solid black;"></td>
					<td style="border-right:1px solid black;padding-left:4px;"><xsl:value-of select="DESC2" /></td>
					<td></td>
				</tr>
		</xsl:if>
							...
							<td style="width:50%;">
								<table style="border-collapse:collapse;width:100%;">
									...
									<tr>
										...
										<td><xsl:value-of select="../PAGE/LINEITEMS/LINEITEM[ITEMNO='511700']/VALUE" /></td>
									</tr>
									<tr>
										<td style="border-right:1px solid black;">
									...
									<tr>
										<td style="border-right:1px solid black;">Charge for Credit(<xsl:value-of select="CHRGCREDITINTRATE"/>)</td>
										<td>
					...
					<table>
						<tr>
							...
							<td style="width:50%;" valign="top">
								...
								<p>
									(11) ''Depending on whether the purchase has been made under the terms of Courts Options Bronze, Silver, Gold or Ultimate credit plan, included in the monthly service charge is an amount of either 0.05%, 0.1% , 0.2% or 0.25% respectively of the total agreement value relating to the purchase of credit protection insurance on an installment basis by the customer from Canterbury Insurance Co. Limited under Master Policy No. CAN-Z-SLI. In the event of the customer dying, or additionally under the Courts Options Silver, Gold and Ultimate credit Plans of the goods being destroyed by ALL risk or the customer becoming disabled, or additionally under Courts Options Gold and Ultimate credit plans the goods being lost through burglary, the outstanding balance due (excluding any arrears) will be paid by Courts subject to the terms and conditions of the Policy.  Also under Options Gold and Options Ultimate credit plans, if the customer is hospitalized as a result of an accident, Courts will pay a months installment for each day of hospitalization up to a maximum of three monthly installments. Also under Courts Options Gold and Ultimate credit plans, if the customer is made redundant or retrenched, no earlier than six months after the commencement of the agreement,  a maximum of 12 installments will be paid by the insurers over the entire term of the policy. The Policy excludes:
									...
									Additionally under the Courts Options Ultimate Protection plan, in the event of the goods being totally destroyed by fire flood or storm, during the first 24 months following delivery of the goods to the Hirer's home and provided the account is up to date; the customer will receive a Courts voucher to the value of 25% of the original price of the goods subject to the terms and conditions of the Policy.
								</p>
								<p>A copy of the policy wording is available on request. Payment of any policy benefit shall be made to Courts as Trustee for the customer to be credited to the appropriate account of the customer and shall be in complete discharge of the liability with respect to the claim to which such benefits relate'' </p>
							</td>
						</tr>
					</table>
					...
					<table>
						...
						<tr>
							...
							<td style="width:50%;" valign="top">
								...
								<p>1. After <xsl:value-of select="../FOOTER/SEVENTYPCTOTAL" /> has been paid, then unless the Hirer has himself put an end to the agreement the Owners of the goods cannot take them back from the Hirer without the Hirer's consent unless the owners obtain an order from the Court.</p>
