	...
	<xsl:template match="/">
		<HTML>
			...
			<BODY>
				...
				<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="600" border="1" align="center">
					<TR>
						<TD style="BORDER-TOP-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none; BORDER-BOTTOM-STYLE: none"><IMG alt="" src="CourtsMalaysiaAgreementLogo.JPG" /><IMG alt="" src="rc.jpg" /></TD>
					</TR>
					<TR>
						<TD class="RFHead1" style="BORDER-TOP: gray 1pt solid; BORDER-BOTTOM: gray 1pt solid; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none">COURTS READY APPLICATION (Yes Card) CUSTOMER DETAILS</TD>
					</TR>
					<TR>
						<TD class="RFHead1" style="BORDER-TOP-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none; BORDER-BOTTOM-STYLE: none">
							<TABLE class="RFHead2" id="Table2" style="HEIGHT: 81px" cellSpacing="1" cellPadding="1" width="100%" border="0" valign="top">
								<TR>
								...
								<TR>
									<TD>
										<xsl:value-of select="RFSUMMARY/CUSTDETAILS/CURRENTADDRESS/ADDRESS3" />
									</TD>
								</TR>
								<TR>
				...
				<P>
					<TABLE class="RFBody" id="Table3" cellSpacing="0" cellPadding="5" width="600" border="1" align="center">
						<TR>
							...
							<TD style="BORDER-RIGHT: gray 1pt solid; BORDER-TOP-STYLE: none; BORDER-BOTTOM: gray 1pt solid; BORDER-LEFT-STYLE: none" vAlign="top" width="30%">
								<TABLE id="Table5" style="HEIGHT: 75px" cellSpacing="1" cellPadding="1" width="100%" border="0" valign="top">
									<TR height="10pt">
										<TD class="RFBody">
											<xsl:value-of select="RFSUMMARY/CUSTDETAILS/DOB" />
										</TD>
									</TR>
									<TR height="12pt">
									...
									<TR height="12pt">
										<TD class="RFBody">
											<xsl:value-of select="RFSUMMARY/CUSTDETAILS/MOBILETEL" />
										</TD>
									</TR>
									<TR height="12pt">
							...
							<TD style="BORDER-TOP-STYLE: none; BORDER-BOTTOM: gray 1pt solid; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none" vAlign="top" width="30%">
								<TABLE id="Table7" style="HEIGHT: 75px" cellSpacing="1" cellPadding="1" width="100%" border="0" valign="top">
									<TR height="11pt">
										<TD class="RFBody">
											<xsl:value-of select="RFSUMMARY/CUSTDETAILS/PROPTYPE" />
										</TD>
									</TR>
									<TR height="12pt">
									...
									<TR height="12pt">
										<TD class="RFBody">
											<xsl:value-of select="RFSUMMARY/CUSTDETAILS/PREVADDRESS/ADDRESS1" />
										</TD>
									</TR>
									<TR height="12pt">
									...
									<TR height="12pt">
										<TD class="RFBody">
											<xsl:value-of select="RFSUMMARY/CUSTDETAILS/PREVADDRESS/ADDRESS3" />
										</TD>
									</TR>
									<TR height="12pt">
						...
						<TR>
							...
							<TD style="BORDER-RIGHT: gray 1pt solid; BORDER-TOP-STYLE: none; BORDER-BOTTOM: gray 1pt solid; BORDER-LEFT-STYLE: none" vAlign="top" width="30%">
								<TABLE id="Table9" style="HEIGHT: 75px" cellSpacing="1" cellPadding="1" width="100%" border="0" valign="top">
									<TR height="12pt">
										<TD class="RFBody">
											<xsl:value-of select="RFSUMMARY/CUSTDETAILS/OCCUPATION" />
										</TD>
									</TR>
									<TR height="12pt">
									...
									<TR height="12pt">
										<TD class="RFBody">
											<xsl:value-of select="RFSUMMARY/CUSTDETAILS/EMPLOYMENTSTAT" />
										</TD>
									</TR>
									<TR height="12pt">
							...
							<TD style="BORDER-TOP-STYLE: none; BORDER-BOTTOM: gray 1pt solid; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none" vAlign="top" width="30%">
								<TABLE id="Table11" style="HEIGHT: 75px" cellSpacing="1" cellPadding="1" width="100%" border="0" valign="top">
									<TR height="12pt">
										<TD class="RFBody"><xsl:value-of select="RFSUMMARY/CUSTDETAILS/MARITALSTAT" /></TD>
									</TR>
									<TR height="24pt">
										<TD class="RFBody">
											<xsl:value-of select="RFSUMMARY/CUSTDETAILS/SPOUSE/EMPLOYMENTSTAT" />
										</TD>
									</TR>
									<TR height="12pt">
									...
									<TR height="12pt">
										<TD class="RFBody">
											<xsl:value-of select="RFSUMMARY/CUSTDETAILS/DEPENDENTS" />
										</TD>
									</TR>
									<TR height="12pt">
										<TD class="RFBody"></TD>
						...
						<TR>
							<TD style="BORDER-RIGHT: gray 1pt solid; BORDER-TOP-STYLE: none; BORDER-LEFT-STYLE: none; BORDER-BOTTOM-STYLE: none" vAlign="top" width="20%">
								<TABLE id="Table12" style="HEIGHT: 75px" cellSpacing="1" cellPadding="1" width="100%" border="0">
									<TR>
										<TD class="RFBody">Gender</TD>
									</TR>
									<TR>
										<TD class="RFBody">Ethnic Group</TD>
									</TR>
									<TR>
										<TD class="RFBody">Nationality</TD>
									</TR>
									<TR>
										<TD class="RFBody">Residential Status</TD>
									</TR>
									<TR>
										<TD class="RFBody">Mortgage/Rent Amount</TD>
									</TR>
									<TR>
										<TD class="RFBody"> </TD>
									</TR>
							...
							<TD style="BORDER-RIGHT: gray 1pt solid; BORDER-TOP-STYLE: none; BORDER-LEFT-STYLE: none; BORDER-BOTTOM-STYLE: none" vAlign="top" width="30%">
								<TABLE id="Table13" style="HEIGHT: 75px" cellSpacing="1" cellPadding="1" width="100%" border="0" valign="top">
									<TR height="11pt">
										<TD class="RFBody">
											<xsl:value-of select="RFSUMMARY/CUSTDETAILS/GENDER" />
										</TD>
									</TR>
									<TR height="12pt">
										<TD class="RFBody"><xsl:value-of select="RFSUMMARY/CUSTDETAILS/ETHNICITY" /></TD>
									</TR>
									<TR height="12pt">
										<TD class="RFBody"><xsl:value-of select="RFSUMMARY/CUSTDETAILS/NATIONALITY" /></TD>
									</TR>
									<TR height="12pt">
										<TD class="RFBody">
											<xsl:value-of select="RFSUMMARY/CUSTDETAILS/RESIDENTIALSTATUS" />
										</TD>
									</TR>
									<TR height="12pt">
										<TD class="RFBody"><xsl:value-of select="RFSUMMARY/CUSTDETAILS/MORTGAGE" />
										</TD>
									</TR>
								</TABLE>
							</TD>
							<TD style="BORDER-RIGHT: gray 1pt solid; BORDER-TOP-STYLE: none; BORDER-LEFT-STYLE: none; BORDER-BOTTOM-STYLE: none" vAlign="top" width="20%">
								<TABLE id="Table14" style="HEIGHT: 19px" cellSpacing="1" cellPadding="1" width="100%" border="0">
									...
									<tr>
										<td class="RFBody">Additional Income</td>
									</tr>
									<tr>
										<td class="RFBody">Utilities</td>
									</tr>
									<tr>
										<td class="RFBody">Loans/Credit Card</td>
									</tr>
									<tr>
										<td class="RFBody">Vehicle Registration No.</td>
									</tr>
									<tr>
							...
							<TD style="BORDER-TOP-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none; BORDER-BOTTOM-STYLE: none" vAlign="top" width="30%">
								<TABLE id="Table15" style="HEIGHT: 19px" cellSpacing="1" cellPadding="1" width="100%" border="0" valign="top">
									<TR height="12pt">
										<TD class="RFBody"><xsl:value-of select="RFSUMMARY/CUSTDETAILS/MONTHLYINCOME" /></TD>
									</TR>
									<tr height="12pt">
										<td class="RFBody">
											<xsl:value-of select="RFSUMMARY/CUSTDETAILS/ADDITIONALINCOME"/>
										</td>
									</tr>
									<tr height="12pt">
										<td class="RFBody">
											<xsl:value-of select="RFSUMMARY/CUSTDETAILS/UTILITIES"/>
										</td>
									</tr>
									<tr height="12pt">
										<td class="RFBody"><xsl:value-of select="RFSUMMARY/CUSTDETAILS/LOANS"/>
										</td>
									</tr>
									<tr height="24pt">
										<td class="RFBody"><xsl:value-of select="RFSUMMARY/CUSTDETAILS/VEHICLEREG"/>
								</td>
									</tr>
									<tr height="12pt">
										<td class="RFBody">
											<xsl:value-of select="RFSUMMARY/CUSTDETAILS/EMPLOYERADDRESS"/>
										</td>
									</tr>
								</TABLE>
							</TD>
				...
				<P>
					<TABLE id="Table16" cellSpacing="0" cellPadding="5" width="600" border="1" align="center">
						<TR>
							<TD class="RFBody" style="BORDER-TOP-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none; BORDER-BOTTOM-STYLE: none">I 
								...
								I understand that a Ready Application (Yes Card) and spending limit has been given based 
				...
				<p>
					<br></br><br></br><br></br><br></br><br></br>
					<TABLE id="Table17" cellSpacing="0" cellPadding="5" width="600" border="1" align="center">
						<TR>
							<TD style="BORDER-TOP-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none; BORDER-BOTTOM-STYLE: none"><IMG alt="" src="CourtsMalaysiaAgreementLogo.JPG" /><IMG alt="" src="rc.jpg" /></TD>
						</TR>
						<TR>
							<TD class="RFHead1" style="BORDER-TOP: gray 1pt solid; BORDER-BOTTOM: gray 1pt; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none">READY APPLICATION (Yes Card) ACCOUNT SUMMARY</TD>
						</TR>
						<TR>
							<TABLE class="RFHead2" style="BORDER-LEFT: gray 1pt solid; BORDER-RIGHT: gray 1pt solid; BORDER-BOTTOM: gray 1pt solid; HEIGHT: 81px" cellSpacing="1" cellPadding="1" width="600" border="0" align="center">
								<TR>
									<TD><xsl:value-of select="RFSUMMARY/CUSTDETAILS/TITLE" />
										<xsl:value-of select="RFSUMMARY/CUSTDETAILS/FIRSTNAME" />
										<xsl:value-of select="RFSUMMARY/CUSTDETAILS/LASTNAME" />
				...
				<p>					
					<TABLE class="RFBody" id="Table18" style="BORDER-BOTTOM-STYLE: none" cellSpacing="0" cellPadding="5" width="600" border="1" align="center">
						<TR>
							<TD class="RFHead2" style="BORDER-RIGHT: gray 1pt solid; BORDER-TOP-STYLE: none; BORDER-LEFT-STYLE: none; BORDER-BOTTOM-STYLE: gray 1pt" width="50%">RA	Account Number</TD>
					...
					<TABLE id="Table19" cellSpacing="0" cellPadding="5" width="600" border="1" align="center">
						<TR class="RFHead2">
					...
					<TABLE class="RFHead2" id="Table20" style="BORDER-TOP-STYLE: none" cellSpacing="0" cellPadding="5" width="600" border="1" align="center">
						<TR>
