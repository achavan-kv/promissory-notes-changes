...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="PAGE">
		<div style="position:relative;PADDING-LEFT: 30px">
			<div style="LEFT: -6px; WIDTH: 150px; POSITION: absolute; TOP: 53px; HEIGHT: 30px"><IMG style="WIDTH: 100%; HEIGHT: 49px" height="49" src="{//AGREEMENTS/@IMAGEPATH}smallLogo.jpg" width="150" />
			</div>
			<div class="smallSS" style="LEFT: 148px; WIDTH: 172px; POSITION: absolute; TOP: 67px; HEIGHT: 25px"><i>(Antigua 
					&amp; Barbuda) Ltd.</i>
			</div>
			...
			<div class="smallSS" style="LEFT: 1px; WIDTH: 718px; POSITION: absolute; TOP: 138px; HEIGHT: 31px">
				This agreement sets out the terms on which <b>Courts (Antigua &amp; Barbuda) 
					Limited</b> whose registered office is at Redcliffe Street, <b>("Courts")</b>
			...
			<div class="smallSS" style="LEFT: 0px; WIDTH: 400px; POSITION: absolute; TOP: 607px; HEIGHT: 73px" align="left">
				...
				<br/>
				Deposit/Initial Payment -[<xsl:value-of select="../FOOTER/DEPOSIT" /> ]<br/>
				[<xsl:value-of select="../FOOTER/INSTALNO" /> ] Monthly payments of [<xsl:value-of select="../FOOTER/FIRSTINST" /> ]<br/>
			...
			<div style="position:relative">
				<div class="SmallPrint" style="LEFT: 1cm; WIDTH: 8.2cm; POSITION: absolute; TOP: 0.25cm; HEIGHT: 18cm" align="justify">
					<b>Late Payments</b>
					<br/>
					<br/>
					...
					of interest as charged in the Total HP Agreement.
					<br/>
					...
					caused.
					<br/>
					Depending on whether you have purchased the Goods using Courts Options Ultimate, 
					Gold, Silver or Take Ten, included in the monthly service charge is an amount of
					0.1%, 0.2% or 0.3% of the Agreement Price to purchase a Consumer Protection
					Insurance Policy on your behalf and in your name with Caribbean Alliance Insurance
					Company Limited under Master Policy number 15CC887347.
					<br/>
					The Insurance Policy purchased under Clause 5.2 above is designed to provide you with 
					insurance in the event of your death. In the case of Courts Options Silver, Gold and
					Ultimate the Insurance Policy is also designed to provide you with insurance in the
					event of your total disablement following an accident or sickness or the Goods being
					destroyed or lost as a result of fire, flood or hurricane. Additionally, in the case
					of Courts Options Gold and Ultimate, the Insurance Policy is designed to provide you
					with insurance in the event that the Goods are lost as a result of the burglary of
					your home. In the case of Courts Options Ultimate the Insurance Policy is designed to
					provide you with 25% of the original cash price back in Courts Cash if your Goods are
					damaged by fire, flood or storm in the 24 months following the date that you entered
					into this Agreement .
					<br/>
					In any of the circumstances set out at Clause 5.3 above, all outstanding payments due
					under this Agreement (apart from any arrears or overdue payments) will be met by
					Insurers on your behalf and paid direct to Courts.  That payment will be credited to
					your account with Courts and, subject to Clause 5.6 below, will release you or your
					estate from your obligations to make further payments under this Agreement.
					<br/>
					In addition to the circumstances set out in Clause 5.3 above, if you have purchased
					the Goods using Courts Options Gold or Ultimate up to 6 of the monthly payments due
					under this Agreement will be met by Insurers and paid to Courts on your behalf if you
					are made redundant and up to 3 of the monthly payments due under this Agreement will
					be met by Insurers and paid to Courts on your behalf if you are hospitalised as a
					result of an accident.
					<br/>
					The Insurance Policy taken out under Clause 5.2 above will not pay out in respect of
					any arrears or overdue payments outstanding at the date of loss of the goods, or your
					death, and you will remain liable to pay all such outstanding sums.  Under the terms
					of the Insurance Policy (a copy is available on request) all sums are paid directly
					to Courts and not to you.
					<br/>
					<br/>
					...
					the Agreement under Clause 6.1, this will not affect Courts' right to terminate the 						
          Agreement in the future for that or any subsequent breach by you.
          <br/>
          Courts may terminate this Agreement if you have given or give us false or incomplete
          information when applying to enter into this Agreement, uncluding, but not limitied
          to, not advising us of any changes to your details as specified on any Ready Finance
          statement issued by Courts to you.
        </div>
				<div class="SmallPrint" style="LEFT: 10.8cm; WIDTH: 8.2cm; POSITION: absolute; TOP: 0.25cm; HEIGHT: 18cm" align="justify">
					...
					<br/>
					Total HP Agreement Price is <xsl:value-of select="../FOOTER/TOTAL" />
					<br/>
					Interest Rate: Option Ultimate 1.45% per month, Option Bronze 0.95% per month, 					
          Option Gold 1.58% per month, Easy Pay Silver 1.45% per month, Take Ten 1.45% per 						
          month, Take Thirty 30% Deposit and 3 equal Installments.
          <br/>
          ...
          I/We further confirm that no information, which might affect Courts decision 
          to make the loan, has been withheld. I/We hereby authorize and consent to Courts
          receiving and exchanging any financial and other information which it may have 
          in its possession about Me/Us with any of its subsidiaries, agents, third party
          assignees, other financial institutions, Credit Bureaus or other person of 
          Corporation/s or with whom I/We may have or propose to have financial dealings 
          from time to time. I/We indemnify Courts against any loss, claims, damages, 
          liabilities, actions and proceedings, legal and or other expense which may be 
          directly and reasonably incurred as a consequence of the disclosure of the 
          ...
          <br/>
					...
					<br/>
					<br/>
					Once you have paid 70% of the Agreement Price, unless You terminate the 
					Agreement yourself, then Courts cannot take back the Goods from you without and 
					Order of the Court unless You agree to let them do so.
					<br/>
					If you have paid less than 70% of the Agreement Price then Courts can take the 
					...
					Schedule of Payments, the Agreement will continue in force.
				</div>
				<div class="SmallPrint" style="LEFT: 10.7cm; WIDTH: 7.6cm; POSITION: absolute; TOP: 16cm; HEIGHT: 5cm" align="justify">
				...
				<div class="SmallPrint" style="LEFT: 0cm; WIDTH: 30px; POSITION: absolute; TOP: 0.25cm; HEIGHT: 18cm" align="justify">
					3
					<br/>
					<br/>
					3.1
          ...
          6.4
				...
				<div class="SmallPrint" style="LEFT: 9.9cm; WIDTH: 9cm; POSITION: absolute; TOP: 7.93cm; HEIGHT: 18cm" align="justify">
					<br/>
          ...
          <br/>
				...
				<div class="SmallPrint" style="LEFT: 9.9cm; WIDTH: 30px; POSITION: absolute; TOP: 0.25cm; HEIGHT: 18cm" align="justify">
					7
					<br/>
					<br/>
					7.1
          ...
          7.5
				...
				<div class="SmallPrint" style="BORDER-RIGHT: gray thin solid; PADDING-RIGHT: 10px; BORDER-TOP: gray thin solid; PADDING-LEFT: 10px; LEFT: 9.8cm; PADDING-BOTTOM: 10px; BORDER-LEFT: gray thin solid; WIDTH: 9.15cm; PADDING-TOP: 10px; BORDER-BOTTOM: gray thin solid; POSITION: absolute; TOP: 19.3cm; HEIGHT: 6.65cm" align="justify">
					...
					<br/>
					<br/>
					In return for Courts entering into this Agreement with You at my request, I agree to guarantee the performance of all your obligations under this Agreement and agree to be jointly and severally liable to Courts under this Agreement, which I have read and understood, if You fail to perform your obligations under this Agreement.
					<br/>
					<br/>
					Print Name:
					<br/>
					...
					<br/>
					<br/>
					Dated the ___________  day of ____________ 
					<br/>
					<br/>
					Address:
					<br/><br/><br/><br/><br/>
