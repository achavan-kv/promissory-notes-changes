  ...
  <xsl:template match="PAGE">
    <div style="position:relative">
      ...
      <table>
        ...
        <tr>
          <td>To: Courts ( Antigua ) Limited (hereinafter referred to as the Lender)</td>
        </tr>
        <br/>
        <br/>
        <tr>
        ...
        <tr>
          <td>
            For value received the undersigned jointly and severally (if more than one), promise to pay Courts ( Antigua ) Limited, (the Company) the sum of <xsl:value-of select="../FOOTER/TOTAL" /> dollars, including interests payable by  installments as follows:
          </td>
        </tr>
        <br/>
        <br/>
        ...
        <tr>
          <td>
            <table width="100%">
              ...
              <tr>
                <td>Witness (on behalf of Courts ( Antigua ) Limited)</td>
                <td>Date</td>
              </tr>
            </table>
          </td>
