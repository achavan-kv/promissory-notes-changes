	...
	<xsl:template match="RESPONSE">	
		<div align="center">
			<table cellspacing="0" cellpadding="0" width="100%">
				<xsl:for-each select="DATA/CONSUMER_REPORT/CONSUMER">
							...
							<table cellspacing="0" cellpadding="0" width="100%">
								...
								<tr>
									<td width="28%" class="cStatHead" colspan="1">
										Enquiry Number 
										<xsl:value-of select="../INQUIRY_NUMBER" />
									</td>
									<td width="44%" class="cStatHead" colspan="2">
										<!--STL Client Reference:<xsl:entity-ref name="nbsp"/>-->
										Client Reference:
										<xsl:value-of select="//CLNT_REF"/>
									</td>
									<td width="28%" class="cStatHead" colspan="1">
										Enquiry Date 
										<xsl:value-of select="../INQUIRY_DATE" />
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td class="cStatDetail"><xsl:value-of select="//ENQ_TYPE" /></td>
									<td class="cStatDetail"><xsl:value-of select="//PRD_TYPE" /></td>									
									<td class="cStatDetail"><xsl:value-of select="//AMOUNT" /></td>									
									<td class="cStatDetail"><xsl:value-of select="CONSUMER_ENQ/GUARANTOR" /></td>									
								</tr>
							</table>
				</td>
			</tr>
									...
									<table cellspacing="0" cellpadding="0" width="100%">
										...
										<tr>
											<td>
												...
												<xsl:for-each select="CONSUMER_IDS">
													<xsl:for-each select="CONSUMER_ID">
														<tr>
															<td>ID</td>
												...
												<xsl:if test="DIALECT_NAME[.!='']">
													<tr>
														<td>Dialect Name</td>

														<td align="right">
															<xsl:value-of select="DIALECT_NAME" />
														</td>
													</tr>
												</xsl:if>

												<xsl:if test="MAIDEN_NAME[.!='']">
													<tr>
														<td>Maiden Name</td>
												...
												<tr>
													...
													<td align="right">
														<xsl:value-of select="ETHNIC_GROUP" />
													</td>
												</tr>

													<xsl:if test="SPOUSE_NAME[.!='']">
													<tr>
														<td>Spouse Name</td>
											...
											<td>
												...
												<xsl:for-each select="SUMMARY">
													<tr>
														...
														<td align="right">
															<xsl:value-of select="INQUIRY_COUNT" />
														</td>
													</tr>
													...
													<tr>
														...
														<td align="right">
															<xsl:value-of select="DEFAULT_COUNT" />
														</td>
													</tr>
													...
													<tr>
														...
														<td align="right">
															<xsl:value-of select="NOTICE_COUNT" />
														</td>
													</tr>
						...
						<tr>
							<td style="padding-bottom: 10px;">
								<table cellspacing="0" cellpadding="0" width="100%">
									...
									<tr>
										<td class="cStatDetail"><xsl:value-of select="DTI_LOAD_DATE" /></td>
										<td class="cStatDetail"><xsl:value-of select="DTI_CREDITOR" /></td> <!--ADDED-->
										<td class="cStatDetail"><xsl:value-of select="DTI_DEBTOR" /></td>
										<td class="cStatDetail"><xsl:value-of select="DTI_CLAIM" /></td>
										<td class="cStatDetail" align="right"><xsl:value-of select="DTI_VALUE" /></td>
										<td class="cStatDetail" align="right"><xsl:value-of select="DTI_BALANCE" /></td>
					<!--<td class="cStatDetail" align="right"><xsl:value-of select="DTI_STATUS" /></td> -->
						<td class="cStatDetail" align="center"><xsl:value-of select="DTI_STATUS" /></td>
										<td class="cStatDetail" align="right"><xsl:value-of select="DTI_STATUS_DATE" /></td>
									</tr>
									</xsl:for-each>
								</table>
							</td>
						...
						<tr>
							<td style="padding-bottom: 10px;">
								<table cellspacing="0" cellpadding="0" width="100%">
									...
									<tr>
										<td class="cStatDetail"><xsl:value-of select="DEBTSTREAM_MSG_TXT" /></td>
									</tr>
								</table>
							</td>
						</tr>
						...
						<tr>
							<td style="padding-bottom: 10px;">
								<table cellspacing="0" cellpadding="0" width="100%">
									...
									<tr>
										<td class="cStatDetail"><xsl:value-of select="BKT_NUMBER" /></td>
										<td class="cStatDetail"><xsl:value-of select="BKT_ORDER_DATE" /></td>
										<td class="cStatDetail"><xsl:value-of select="BKT_PETITON_DATE" /></td>
										<td class="cStatDetail"><xsl:value-of select="BKT_ORG_ORD_DATE" /></td>
										<td class="cStatDetail"><xsl:value-of select="BKT_GAZETTE_DATE" /></td>
									</tr>
		                                                    
									<tr>
                                       	<td class="cStatDetail" width="95%" colspan="5"><xsl:value-of select="BKT_NATURE_OF_ORDER" /><br /><br /></td>
									</tr>
									</xsl:for-each> 
							...
							<td style="padding-bottom: 10px;">
								<table cellspacing="0" cellpadding="0" width="100%">
									...
									<xsl:for-each select="IPN_TEXT">
										<tr>
											<td class="cStatDetail" colspan="3"><!--STL <pre />-->
						...
						<td style="padding-bottom: 10px;">
							<table cellspacing="0" cellpadding="0" width="100%">
								<tr>
									<td class="cStatHead" colspan="2">Disclaimer</td>
								</tr>

								<tr>
									<td class="cStatDetail" colspan="2">
