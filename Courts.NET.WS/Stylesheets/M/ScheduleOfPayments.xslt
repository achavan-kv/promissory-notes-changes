...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="SCHEDULEOFPAYMENTS">
		...
		<table width="700">
			<tr class="RFHead1" >
				...
				<td width="14%" align="center">Monthly Instalment</td>
        <td width="14%" align="center">Charges for the month</td>
        <td width="14%" align="center">Chargeable Price Component (Capital)</td>
        <td width="14%" align="center">Opening Balance of Chargeable Price (Capital)</td>
        <td width="14%" align="center">Closing Balance of Chargeable Price (Capital)</td>
	...
	<xsl:template match="HEADER">
		...
		<table width="700">
			<tr>
				...
				<td class="RFBody" width="80%">Courts (Mauritius) Ltd</td>
			</tr>
			<tr>
	...
	<xsl:template match="INSTALMENT">
		<tr class="RFBody" >
			...
			<td width="14%" align="center"><xsl:value-of select="MONTHLYINSTALMENT" /></td>
			<td width="14%" align="center"><xsl:value-of select="MONTHLYCHARGE" /></td>
			<td width="14%" align="center"><xsl:value-of select="MONTHLYCAPITAL" /></td>
			<td width="14%" align="center"><xsl:value-of select="OPENINGBALANCE" /></td>
			<td width="14%" align="center"><xsl:value-of select="CLOSINGBALANCE" /></td>
		</tr>
	</xsl:template>
	...
	<xsl:template match="FOOTER">
		<table width="700" class="RFHead2">
			<tr>
				...
				<td width="14%" align="center"></td>
				<td width="14%" align="center"><xsl:value-of select="TOTAL" /></td>
				<td width="14%" align="center"><xsl:value-of select="CHARGETOTAL" /></td>
				<td width="14%" align="center"><xsl:value-of select="CAPITALTOTAL" /></td>
				<td width="14%" align="center"></td>
				<td width="14%" align="center"></td>
			</tr>
		</table>
