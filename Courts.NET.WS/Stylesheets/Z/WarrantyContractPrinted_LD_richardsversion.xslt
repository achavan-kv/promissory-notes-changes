        ...
        Extended Warranty
			...
			<DIV style="LEFT: 0.3cm; WIDTH: 18.2cm; POSITION: absolute; TOP: 25cm; HEIGHT: 0.317cm">
				<TABLE class="WarrantyHeader" id="Table18" cellSpacing="1" cellPadding="1" width="100%" border="0">
					<TR>
						...
						<TD vAlign="bottom" width="40%">SIGNED ON BEHALF OF TROPIGAS</TD>
          ...
          TROPIGAS<br/>
				...
				<DIV class="smallPrint" style="LIST-STYLE-POSITION: outside; Z-INDEX: 101; LEFT: 37px; WIDTH: 7.766cm; LIST-STYLE-TYPE: disc; POSITION: absolute; TOP: 3cm; HEIGHT: 5.279cm; TEXT-ALIGN: justify" ms_positioning="FlowLayout"><u>PERIOD 
						OF COVER</u><br/>
					<br/>
					This Service Contract (“contract”) extends the Tropigas (“we”, “our”) initial 
					warranty for a further 18 months on furniture and 18 months on electrical 
					products. This means that inclusive of the Tropigas initial warranty period, your 
					...
					<UL>
						...
						<LI>
							<DIV style="MARGIN-LEFT: -20px">Manufacturer’s recall or modifications or damage 
								not covered under Tropigas initial warranty.
							</DIV>
						</LI>
						<LI>
				...
				<DIV class="smallPrint" style="LEFT: 10cm; WIDTH: 9cm; POSITION: absolute; TOP: 3cm; HEIGHT: 18.737cm; TEXT-ALIGN: justify" ms_positioning="FlowLayout">
					...
					<ul>
						...
						<LI>
							<DIV style="MARGIN-LEFT: -20px">Contact your local Tropigas Store, or ring 
					...
					<br/>
					<br/>
					FOR CLAIMS AND INQUIRIES CALL YOUR LOCAL TROPIGAS STORE OR PHONE x800xxx xxxx
					<br/>
					<br/>
					Tropigas offer this contract. We reserve the right to amend 
