...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="CONTRACT">
		<div style="position:relative">
			<DIV style="Z-INDEX: 139; LEFT: 0.1cm; WIDTH: 3.832cm; POSITION: absolute; TOP: 0.503cm; HEIGHT: 0.11cm"><IMG style="WIDTH: 426px; HEIGHT: 110px" height="110" alt="" src="TROPIGAS.jpg" width="426" /></DIV>
			...
			<DIV style="BORDER-RIGHT: gray 1px solid; BORDER-TOP: gray 1px solid; Z-INDEX: 135; LEFT: 0cm; BORDER-LEFT: gray 1px solid; WIDTH: 19cm; BORDER-BOTTOM: gray 1px solid; POSITION: absolute; TOP: 14.4cm; HEIGHT: 11.4cm"></DIV>
				...
				<TABLE class="WarrantyHeader" id="Table15" cellSpacing="1" cellPadding="1" width="100%" border="0">
					<TR>
						...
						<TD vAlign="top" width="50%">
							...
							<b>24 months from Date Delivered</b>
						</TD>
					</TR>
				</TABLE>
			</DIV>
			...
			<DIV style="LEFT: 1.295cm; WIDTH: 16.5cm; POSITION: absolute; TOP: 23.099cm; HEIGHT: 1cm">
				<TABLE class="WarrantyFooter" id="Table16" cellSpacing="1" cellPadding="1" width="100%" border="0">
					<TR>
						<TD vAlign="top" align="middle" width="40%">PLEASE READ THE TERMS &amp; 
							CONDITIONS BEFORE SIGNING</TD>
					</TR>
				</TABLE>
			</DIV>
			<DIV style="LEFT: 0.292cm; WIDTH: 18.2cm; POSITION: absolute; TOP: 23.80cm; HEIGHT: 0.317cm">
			...
			<DIV style="LEFT: 0.3cm; WIDTH: 18.2cm; POSITION: absolute; TOP: 23.80cm; HEIGHT: 0.317cm">
				<TABLE class="WarrantyHeader" id="Table18" cellSpacing="1" cellPadding="1" width="100%" border="0">
					<TR>
						...
						<TD vAlign="bottom" width="40%">SIGNED ON BEHALF OF UNICOMER (Belize) Limited</TD>
			...
			<DIV style="LEFT: 1.295cm; WIDTH: 16.5cm; POSITION: absolute; TOP: 24.95cm; HEIGHT: 0cm">
			...
			<br class="pageBreak" />
			<div style="POSITION: relative">
				<DIV class="smallSS" style="FONT-WEIGHT: bold; Z-INDEX: 100; WIDTH: 20cm; POSITION: absolute; HEIGHT: 1cm; TEXT-ALIGN: center" ms_positioning="FlowLayout">UNICOMER (Belize) Limited 
					<br/>
				...
				<DIV class="smallPrint" style="LIST-STYLE-POSITION: outside; Z-INDEX: 101; LEFT: 37px; WIDTH: 7.766cm; LIST-STYLE-TYPE: disc; POSITION: absolute; TOP: 3cm; HEIGHT: 5.279cm; TEXT-ALIGN: justify" ms_positioning="FlowLayout"><u>PERIOD 
						OF COVER</u><br/>
					<br/>
					This Service Contract (“contract”) extends the UNICOMER (“we”, “our”) initial 
					warranty for a further 18 months on furniture and 18 months on electrical 
					products. This means that inclusive of the UNICOMER initial warranty period, your 
					product is covered for a total of 2 years starting on the date of 
					...
					<u>CONDITIONS</u><br/>
					<br/>
					This contract may only be purchased within 30 days of delivery of a covered 
				...
				<DIV class="smallPrint" style="LEFT: 10cm; WIDTH: 9cm; POSITION: absolute; TOP: 3cm; HEIGHT: 18.737cm; TEXT-ALIGN: justify" ms_positioning="FlowLayout">
					...
					<ul>
						...
						<LI>
							<DIV style="MARGIN-LEFT: -20px">Contact your local cbl TROPIGAS Store, or ring 
								223-7756 for assistance. You will be told how to proceed with the repair.
							</DIV>
						</LI>
						<LI>
					...
					<br/>
					<br/>
					You may cancel this contract for any reason within 30 days of the date of 
					...
					<br/>
					<br/>
					FOR CLAIMS AND INQUIRIES CALL YOUR LOCAL cbl TROPIGAS STORE OR PHONE 223-7756
					<br/>
					<br/>
					UNICOMER (Belize) Limited offer this contract. We reserve the right to amend 
