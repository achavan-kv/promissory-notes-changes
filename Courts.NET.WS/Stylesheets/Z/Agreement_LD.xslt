...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="PAGE">
		<div style="position:relative">
			<div style="LEFT: -6px; WIDTH: 150px; POSITION: absolute; TOP: 0px; HEIGHT: 30px">
				<IMG src="{//AGREEMENTS/@IMAGEPATH}TropigasLogo.png" width="150px" height="48px" />
			</div>
			<div class="smallSS" style="LEFT: 148px; WIDTH: 172px; POSITION: absolute; TOP: 15px; HEIGHT: 25px"> 
			...
			<div class="smallSS" style="LEFT: 1px; WIDTH: 718px; POSITION: absolute; TOP: 88px; HEIGHT: 31px">
				<b>Between cbl TROPIGAS  
					</b> whose principal place of business is at 135 Corner West and Basra Streets in Belize City (hereinafter called the "Owner" which expression 
            ...
            <div class="RFHead1" style="LEFT: 0px; WIDTH: 400px; POSITION: absolute; TOP: 590px; HEIGHT: 125px" align="left">
				<b>WE ALWAYS GIVE YOU MORE!</b><br/>
            </div>
			...
			<xsl:if test="$ninety != ''">
				<div class="smallSS" style="LEFT: 200px; WIDTH: 170px; POSITION: absolute; TOP: 607px; HEIGHT: 85px" align="Left">
					<b>cbl TROPIGAS will rebate to the Total Regular Price if payments of
			...
			<div class="smallSS" style="LEFT: 0px; WIDTH: 717px; POSITION: absolute; TOP: 655px; HEIGHT: 31px" align="center">
				WHEREBY cbl TROPIGAS will supply and the customer will take the goods listed in the  
			...
			<div class="SmallPrint" style="LEFT: 36px; WIDTH: 700px; POSITION: absolute; TOP: 840px; HEIGHT: 99px" align="justify" id="Div3" language="javascript" onclick="return DIV1_onclick()">
				...
				such payments to be made to the Owner at 135 Corner West and Basra Streets, in Belize City, or at such other address as the Owner may direct;
				<br/>
				<br/>
                                <br/>
			...
			<div class="SmallPrint" style="LEFT: 2cm; WIDTH: 15.2cm; POSITION: absolute; TOP: -1.25cm; HEIGHT: 18cm" align="justify">
				...
				<br/>
				<br/>
				Depending on whether the purchase has been made under the terms of cbl TROPIGAS Premium, 
				Standard or Basic Options, <b>included in the service charge is
				an amount of, in case of cbl TROPIGAS Premium, 0.2% of the total service charge value or, in the
				case of Standard and Basic, 0.1% of the total service charge value relating </b>to
				...
				under Master Policy No. CIO200.  In the event of the goods being destroyed by All
                                Risks or the customer dying or becoming disabled, or, additionally under the cbl TROPIGAS 
                                Premium Protection Plan, the loss results from burglary or the customer being
                                ...
                                The type of insurance that has been purchased is evidenced by the cbl TROPIGAS Payment Protection Plan
                                certificate provided at the time that the goods were purchased.
                                <br/>
				<br/>
				<br/>
				Payment of any policy benefit shall be made to cbl TROPIGAS as Trustee
			...
			<div class="SmallPrint" style="BORDER-RIGHT: gray thin solid; PADDING-RIGHT: 10px; BORDER-TOP: gray thin solid; PADDING-LEFT: 10px; LEFT: 9.8cm; PADDING-BOTTOM: 10px; BORDER-LEFT: gray thin solid; WIDTH: 9.15cm; PADDING-TOP: 10px; BORDER-BOTTOM: gray thin solid; POSITION: absolute; TOP: 18.3cm; HEIGHT: 6.65cm" align="justify">
				<b>GUARANTEE</b> (Where required by cbl TROPIGAS)
				<br/>
				<br/>
				In return for cbl TROPIGAS entering into this Agreement with You at my request, I agree to guarantee the performance of all your obligations under this Agreement and agree to be jointly and severally liable to cbl TROPIGAS under this Agreement, which I have read and understood, if You fail to perform your obligations under this Agreement.
				<br/>
				<br/>
				Print Name:
				<br/>
