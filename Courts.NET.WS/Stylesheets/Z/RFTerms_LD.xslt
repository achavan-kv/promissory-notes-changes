...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="RFTERMS">
        ...
        <div style="LEFT: 0.3cm; WIDTH: 3cm; POSITION: absolute; HEIGHT: 1cm">
            <IMG style="HEIGHT: 50px" src="Stylesheets/T/smallLDLogo_RFTerms.png" />
        </div>
        <div class="smallSS" style="LEFT: 0.5cm; POSITION: absolute; TOP: 3.5cm">
            This agreement explains
            the terms of our plan and governs its use at all times. In this
            agreement the word “you” and “your” refer to each and all of the persons who
            use a limit issued by us, under an account that we hold. The word
            “we”, “us” and “our” means Unicomer (Belize) Limited.
            <br/>
            When you accept or use our limit, you agree to the terms in this agreement.
        </div>
        ...
        <div class="smallSS" style="BORDER-RIGHT: gray thin solid; PADDING-RIGHT: 5px; BORDER-TOP: gray thin solid; PADDING-LEFT: 5px; LEFT: 2.5cm; PADDING-BOTTOM: 5px; BORDER-LEFT: gray thin solid; WIDTH: 8.7cm; PADDING-TOP: 5px; BORDER-BOTTOM: gray thin solid; POSITION: absolute; TOP: 5.414cm; HEIGHT: 4.7cm">
            Account
            Number:
            <br/>
            <br/>
        ...
        <div class="smallSS" style="LEFT: 0cm; WIDTH: 1cm; POSITION: absolute; TOP: 11cm; TEXT-ALIGN: justify">
            <b>1</b>
            <br/>
            1.1
            <br/>
        ...
        <div class="smallSS" style="LEFT: 1cm; WIDTH: 8cm; POSITION: absolute; TOP: 11cm; TEXT-ALIGN: justify">
            <b>Limit</b>
            <br/>
            You may use the limit to purchase goods at any Branch of Unicomer (Belize) Limited
            <br/>
            <br/>
            <b>Account Structure</b>
            <br/>
            You will have one master account with a spending limit.
            <br/>
            Each purchase that you make under this account will be referred to as a
            "sub-agreement" and covered by an individual contract.
            <br/>
            <br/>
            <b>Easy Payment Plan</b>
            <br/>
            All your transactions will be subject to the Easy Payment Plan Agreement.
            <br/>
            <br/>
            <b>Payments</b>
            <br/>
            You will make one single payment on or before the agreed payment date each month
            to cover the monthly instalment on your account.
            <br/>
            Your monthly payment date will be one month after the delivery of the first
            item of goods by us.
            <br/>
            Your monthly payment will be applied on a pro rata basis across all outstanding agreements.
            <br/>
        ...
        <div class="smallSS" style="LEFT: 9.5cm; WIDTH: 1cm; POSITION: absolute; TOP: 11cm; TEXT-ALIGN: justify">
            5.2
            <br/>
            <br/>
            5.3
        ...
        <div class="smallSS" style="LEFT: 10.5cm; WIDTH: 8cm; POSITION: absolute; TOP: 11cm; TEXT-ALIGN: justify">
            Your
            ...
            <br/>
            If your account becomes more than 2 months overdue your account
            will be barred from making additional purchases and your available spending
            limit terminated. Each sub-contract will be treated as individual Easy Payment Plan agreements and your account will be allocated for collection.
            <br/>
            <br/>
            <b>Unicomer rights</b>
            <br/>
            ...
            <br/>
            In the event that you fail to present adequate proof of identity when using
            your limit, this will result in your purchase being denied.
        </div>
