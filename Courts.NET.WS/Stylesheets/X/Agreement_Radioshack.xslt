...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="PAGE">
    <div style="position:relative">
      ...
      <br class="pageBreak" />
      <div class="SmallPrintCuracao" style="LEFT: 0.5cm; WIDTH: 8cm; POSITION: absolute; TOP: 1cm; HEIGHT: 12.5cm; font-size:13px;" align="justify" id="Div3" language="javascript" onclick="return DIV1_onclick()">
        <b>Article 9</b>
        <br />
      ...
      <div class="SmallPrintCuracao" style="LEFT: 9.75cm; WIDTH: 8cm; POSITION: absolute; TOP: 1cm; HEIGHT: 12.5cm; font-size:13px" align="justify" id="Div5" language="javascript">
        <b>Article 11</b>
        <br />
      ...
      <div class="SmallPrint" style="LEFT: 0cm; WIDTH: 8cm; POSITION: absolute; TOP: 22.5cm; HEIGHT: 12.5cm; font-size:13px" align="justify" id="Div5" language="javascript">
        Curacao <br/>
        <br />
      ...
      <div class="SmallPrint" style="LEFT: 9.75cm; WIDTH: 8cm; POSITION: absolute; TOP: 22.5cm; HEIGHT: 12.5cm; font-size:13px" align="justify" id="Div5" language="javascript">
        <br />
        <br />
        <br />
        __________________________________________
