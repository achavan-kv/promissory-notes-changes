...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="HEADER">
		<TABLE class="normalBold" id="Address" height="7" width="600" border="0">
			<TR>
				<TD align="center">CoSACS Consolidated Picking List</TD>
			</TR>
		</TABLE>
		<P></P>			
		<P></P>			
		...
		<TABLE class="normal" height="7" width="600" border="0">
			<TR>
				<TD width="10%" align="left" colspan="2">Picking List <xsl:value-of select="PICKNUMBER" />
				</TD>
			</TR>
		</TABLE>
		<TABLE class="normal" height="7" width="600" border="0">
		...
		<P></P>			
		<P></P>			
		<TABLE class="normal" id="Headings" width="750" border="0">
      <!--<TR class="normalBold">Store Type: <xsl:value-of select="STORETYPE" />
    </TR>-->
			<TR class="normalBold">
        <TD width="10%">Store Type</TD>
				<TD width="10%">D/N No's</TD>
				<!--<TD width="15%">Product Category</TD>-->
                <TD width="15%">
                    Product <xsl:value-of select="CATEGORYHEADING"/>
                </TD>    
	...
	<xsl:template match="DELIVERYNOTE">
		<TABLE class="normal" id="Delivery" width="750" border="0">
			<TR>
        <xsl:apply-templates select="STORETYPE" />
  ...
  <xsl:template match="STORETYPE">
    <TD id="storeType" align="left" width="10%">
      <xsl:apply-templates />
    </TD>
  </xsl:template>
	...
	<xsl:template match="DESC1">
		<TD id="desc1" align="left" width="40%">
			<xsl:apply-templates />
		</TD>
	</xsl:template>

	<xsl:template match="QUANTITY">
		<TD id="price" align="right" width="10%">
			<xsl:apply-templates />
		</TD>
	</xsl:template>
