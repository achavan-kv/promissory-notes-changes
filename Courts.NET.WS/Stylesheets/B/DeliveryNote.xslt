...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="HEADER">
		...
		<TABLE class="normal" id="Address" height="8" width="830" border="0">
			<TR>
		...
		<TABLE class="normal" height="10" width="830" border="0">
			<TR>
				<TD width="65%">
					<STRONG>
	...
	<xsl:template match="FOOTER">
		...
		<xsl:if test="COD='Y'">
			<div style="position:absolute; top=19cm; left=6.5cm; width=100%" align="left">
				<B>
					<U>
						<I>C.O.D.</I>
					</U>
			...
			<div style="position:absolute; top=20cm; width=100%" align="center">
				<table class="normal" height="7" width="830" border="0">
					<tr>
		...
		<div id="SalesPerson" style="position:absolute; top=23cm; width=100%" align="center">
	...
	<xsl:template match="NOTES">
		...
		<td width="15%"></td>
			<td width="12%"></td>
			<td id="notes" align="left" width="40%">
				<xsl:apply-templates />
			</td>
			<td width="*"></td>
		</TR>
