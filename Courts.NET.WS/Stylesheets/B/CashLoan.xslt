  ...
  <xsl:template match="PAGE">
    <div style="position:relative">
      ...
      <table>
        ...
        <tr>
          <td>To: UNICOMER ( Barbados ) Limited (hereinafter referred to as the Lender)</td>
        </tr>
        <br/>
        <br/>
        <tr>
        ...
        <tr>
          <td>
            For value received the undersigned jointly and severally (if more than one), promise to pay UNICOMER ( Barbados ) Limited, (the Company) the sum of <xsl:value-of select="../FOOTER/TOTAL" /> dollars, including interests payable by installments as follows:
          </td>
        </tr>
        <br/>
        <br/>
        ...
        <tr>
          <td>
            <table width="100%">
              ...
              <tr>
                <td>Witness (on behalf of UNICOMER ( Barbados ) Limited)</td>
                <td>Date</td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td>
            I also authorize and instruct <xsl:value-of select="HEADER/EMPLOYER" /> &#160; <xsl:value-of select="HEADER/EMPYADD1" /> &#160; <xsl:value-of select="HEADER/EMPYADD2" /> &#160; <xsl:value-of select="HEADER/EMPYADD3" /> &#160; <xsl:value-of select="HEADER/EMPYPOCODE" /> and the Employer hereby agrees that on the receipt of the signed  Note by <xsl:value-of select="HEADER/NAME" /> (the Employee) to deduct the sum of <xsl:value-of select="../FOOTER/TOTAL" /> from the salary of <xsl:value-of select="HEADER/NAME" /> (the Employee) for remittance to UNICOMER ( Barbados ) LIMITED in <xsl:value-of select="../FOOTER/INSTALNO"/> payments COMMENCING <xsl:value-of select="../FOOTER/INSTALTABLE/INSTALMENTDATE"/>, until the entire Note and related charges( if any) are paid off to UNICOMER ( Barbados ) LIMITED
          </td>
        </tr>
        <br/>
        <br/>
