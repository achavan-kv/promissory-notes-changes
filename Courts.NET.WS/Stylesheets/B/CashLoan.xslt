...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="PAGE">
    <div style="position:relative">
      <!-- Header -->
      <p class="header" style="font-family:Helvetica, font-size:16px;">UNICOMER (BARBADOS) LTD</p>
      ...
      <p>
        BETWEEN UNICOMER (BARBADOS) LTD, a limited liability company, having its registered office at St George Street, Bridgetown, Barbados, (hereinafter called "the Lender”), AND <xsl:value-of select="HEADER/NAME" /> <xsl:choose>
      ...
      <p>
        The Lender has agreed to lend, and the Borrower(s) has agreed to borrow, a loan of <xsl:value-of select="HEADER/LOANAMOUNTWORDS"/> (BDS$<xsl:value-of select="HEADER/LOANAMOUNT"/>) on the following terms and conditions.
      </p>
      ...
      <ol>
        <li>
          ...
          <ol>
            <li>
              Subject to the terms and conditions hereinafter contained the Lender agrees to lend to the Borrower(s) the sum of <xsl:value-of select="HEADER/LOANAMOUNTWORDS"/> (BDS$<xsl:value-of select="HEADER/LOANAMOUNT"/>) (hereinafter called “the Loan”).
            </li>
            <li>
              In consideration of the Loan, the Borrower(s) jointly and severally agrees to repay the Loan including interest as provided in <b>Clause 2</b> below and in the manner summarized in <b>
                Schedule I<b/> and outlined in <b>
                  Schedule II<b/> attached hereto, together with any applicable fees stated herein.
                </li>
            <li>
              The attached <b>
                Schedule III – Fact Sheet<b/> summarises the key terms of this Loan Agreement.
              </li>
          </ol>
        </li>
        ...
        <li>
          ...
          <ol>
            <li>
              The Borrower(s) shall pay to the Lender, interest at the rate of <xsl:value-of select="../FOOTER/INTERESTRATEWORD"/>) per cent (<xsl:value-of select="../FOOTER/INTERESTRATE"/>) per annum on the principal sum of the Loan, from the date of disbursement.
            </li>
            <li>
              All interest hereunder shall be calculated on the reducing balance at the applicable rate as aforesaid for each interest period on the basis of the actual days elapsed and on the basis of a year of 365 days.
            </li>
          </ol>
        </li>
        ...
        <li>
          ...
          <ol>
            <li>
              The Loan principal shall be repaid together with any accrued and unpaid interest and fees due thereon by <xsl:value-of select="../FOOTER/INSTALNOWORDS"/>(<xsl:value-of select="../FOOTER/INSTALNO"/>) equal monthly installments of <xsl:value-of select="../FOOTER/FIRSTINSTWORD" /> (BDS$<xsl:value-of select="../FOOTER/FIRSTINST" />) which shall include the annual interest of <xsl:value-of select="../FOOTER/INTERESTRATE"/>. Each installment shall be due and payable on the same date in each month as the date on which the Loan was disbursed (the “Disbursement Date”) commencing the next calendar month after the said Disbursement Date. See Schedule II attached hereto.
            </li>
            <li>
        ...
        <li>
          ...
          <ol>
            ...
            <li>
              For the avoidance of doubt, since interest will be calculated on the reducing balance, if the entire Loan is paid before the final payment is due, the Borrower(s) shall not be entitled to any reimbursement from the Lender.
            </li>
          </ol>
        </li>
        ...
        <p>
          In consideration of the Lender’s agreement to grant the Loan, the Borrower shall pay to the Lender a non‑refundable Administrative/ Processing Fee in the amount <xsl:value-of select="../FOOTER/PROCESSINGFEEWORD" /> (BDS$<xsl:value-of select="../FOOTER/PROCESSINGFEE" />), which shall be deducted from the proceeds of the Loan.
        </p>
        ...
        <li>
          ...
          <ol>
            <li>
              The parties agree that this Agreement and any other ancillary documents to be delivered in connection herewith could be made and delivered electronically.
            </li>
            <li>
              The parties further agree that this Agreement may be electronically signed, and any electronic signatures appearing on this Agreement, or such other ancillary documents, are the same as handwritten signatures for the purposes of validity, enforceability, and admissibility.
            </li>
          </ol>
        </li>
        ...
        <p>
          Any Notice required by this agreement may be delivered to the Borrower(s) personally or by post or electronic mail or by text message, without proof of receipt provided that the method of delivery is based on information on file for the Borrower(s).
        </p>
        ...
        <li>
          ...
          <ol>
            ...
            <li>
              This Agreement and Schedules I, II and III constitutes the entire agreement between the parties with respect to the subject matter hereof and supersedes all other prior agreements and understandings, both written and oral, between the parties with respect to the subject matter hereof.
            </li>
            <li>
              Notice shall be mailed by registered post to the last known address on record of the principal Borrower(s).
            </li>
          </ol>
        </li>
      </ol>
      ...
      <p>
        ...
        UNICOMER (BARBADOS) LTD<br/>
        By TRISHA TANNIS ) __________________________________<br/>
        Director<br/>
        ____________________________________<br/>
        Witness
      </p>
      ...
      <table width="100%">
        ...
        <tr>
          ...
          <td>Loan Amount</td>
          <td>
            BDS$<xsl:value-of select="HEADER/LOANAMOUNT"/>
          </td>
        </tr>
        <tr>
          <td>2</td>
        ...
        <tr>
          ...
          <td>
            ...
            <p>
              Monthly installments – BDS$<xsl:value-of select="../FOOTER/FIRSTINST" />
            </p>
            <p>
        ...
        <tr>
          ...
          <td>
            The Borrower shall pay to the Lender a non-refundable Administrative/ Processing Fee in the amount <xsl:value-of select="../FOOTER/PROCESSINGFEEWORD" /> (BDS$<xsl:value-of select="../FOOTER/PROCESSINGFEE" />), which shall be deducted from the proceeds of the Loan.
          </td>
        </tr>
        <tr>
          <td>8</td>
