		...
		<HTML>
			...
			<BODY>
				<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="600" border="1">
					<TR>
						<TD style="BORDER-TOP-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none; BORDER-BOTTOM-STYLE: none"><IMG alt="" src="Stylesheets/T/smallLDLogo_RFSummary.png" /></TD>
					</TR>
					<TR>
