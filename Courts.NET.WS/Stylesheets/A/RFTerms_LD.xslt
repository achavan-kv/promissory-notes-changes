...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="RFTERMS">
        ...
        <div class="smallSS" style="LEFT: 0.5cm; POSITION: absolute; TOP: 3.5cm">This agreement explains 
			...
			“we”, “us” and “our” means Unicomer Guyana Limited.
			<br/>
		...
		<div class="smallSS" style="LEFT: 1cm; WIDTH: 8cm; POSITION: absolute; TOP: 11cm; TEXT-ALIGN: justify"><b>Ready 
				Finance Card</b>
			<br/>
			The card remains the property of Unicomer Guyana Limted 
			<br/>
            You may use the card to purchase goods at any Branch of Unicomer Guyana Limted
            <br/>
			<br/>
			...
			<b>Payments</b>
			<br/>
			You will make one single payment on or before the agree payment date each month 
			...
			personal information proves to have been falsely supplied we resrve the right 
		...
		<div class="smallSS" style="LEFT: 10.5cm; WIDTH: 8cm; POSITION: absolute; TOP: 11cm; TEXT-ALIGN: justify">Your 
			...
			<br/>
			<br/>
			<b>Unicomer Guyana Limted's rights</b>
			<br/>
