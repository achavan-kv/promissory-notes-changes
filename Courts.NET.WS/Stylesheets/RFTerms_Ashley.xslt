...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="RFTERMS">
        ...
        <div style="LEFT: 0.3cm; WIDTH: 3cm; POSITION: absolute; HEIGHT: 1cm">
            <IMG style="HEIGHT: 50px" src="Ashley.png" />
        </div>
        <div class="smallSS" style="LEFT: 0.5cm; POSITION: absolute; TOP: 3.5cm">This agreement explains 
			...
			“we”, “us” and “our” means Unicomer Limited.
			<br/>
      ...
      <br/>
		...
		<div class="smallSS" style="LEFT: 1cm; WIDTH: 8cm; POSITION: absolute; TOP: 11cm; TEXT-ALIGN: justify"><b>Ready 
				Finance Card</b>
			<br/>
			The card remains the property of Unicomer Jamaica Limited.
			<br/>
			You may use the card to purchase goods at any Branch of Unicomer Jamaica Limited.
			<br/>
			<br/>
			...
			<br/>
			<br/>
      <b>Hire Purchase and Security Interest in Personal Property Acts</b>
			<br/>
			All transactions will be subjected to the above Acts.
			<br/>
			<br/>
			<b>Payments</b>
			<br/>
			...
			prop rata basis across all outstanding hire purchase agreements.
			<br/>
		...
		<div class="smallSS" style="LEFT: 1cm; WIDTH: 8cm; POSITION: absolute; TOP: 23.5cm; TEXT-ALIGN: justify">
			Signature:
			<br />
			<br />
      <br />
