...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
					...
					<TABLE class="normal" width="100%" border="0">
						<TR>
							<TD>
								...
								<xsl:if test="$ninety != ''">
									Unicomer will rebate to the Total Regular Price if payments of
	...
	<xsl:template match="HEADER">
		<div style="LEFT: 1px; WIDTH: 185px; POSITION: absolute; TOP: 53px; HEIGHT: 100px">
			<IMG src="{//AGREEMENTS/@IMAGEPATH}LuckyDollarLogo.png" width="185px" height="100px" />
		</div>
