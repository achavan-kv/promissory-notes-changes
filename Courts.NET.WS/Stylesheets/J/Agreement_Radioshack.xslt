  ...
  <xsl:template match="PAGE">
    <div style="position:relative">
      <div style="LEFT: 0cm; WIDTH: 18.5cm; POSITION: absolute; TOP: 0cm; HEIGHT: 2cm">
        <IMG src="{//AGREEMENTS/@IMAGEPATH}unicomer.png" height="50px" />
      </div>
      ...
      <div style="position:relative">
        ...
        The <b>Customer</b> shall keep the goods at the address set out in this Agreement and shall not allow them to be removed 
		without first receiving the written consent of <b>Radio Shack</b>.
        </span>
          <br />
          <br />
        ...
        <div style="position:absolute; left:0cm; width: 9.2cm; height:6cm; top: 19cm; border:gray thin solid; font-size:10px; font-family:sans-serif; padding:10px;">
