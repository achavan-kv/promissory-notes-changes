		...
		<HTML>
			...
			<BODY>
				<TABLE id="Table1" cellSpacing="0" cellPadding="5" width="600" border="1">
					<TR>
						<TD style="BORDER-TOP-STYLE: none; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none; BORDER-BOTTOM-STYLE: none"><IMG alt="" src="Stylesheets/J/smallLDLogo_RFSummary.png" /></TD>
					</TR>
					<TR>
						<TD class="RFHead1" style="BORDER-TOP: gray 1pt solid; BORDER-BOTTOM: gray 1pt solid; BORDER-RIGHT-STYLE: none; BORDER-LEFT-STYLE: none">LUCK
					</TR>
					<TR>
