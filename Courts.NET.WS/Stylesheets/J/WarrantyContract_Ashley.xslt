...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="CONTRACT">
		<div style="position:relative">
			...
			<br class="pageBreak" />
			<div style="POSITION: relative">
				<DIV class="smallSS" style="FONT-WEIGHT: bold; Z-INDEX: 100; WIDTH: 20cm; POSITION: absolute; HEIGHT: 1cm; TEXT-ALIGN: center" ms_positioning="FlowLayout"><br/>
					SERVICE CONTRACT TERMS AND CONDITIONS</DIV>
				<DIV class="smallPrint" style="LIST-STYLE-POSITION: outside; Z-INDEX: 101; LEFT: 0.6cm; WIDTH: 8.5cm; LIST-STYLE-TYPE: disc; POSITION: absolute; TOP: 1cm; HEIGHT: 5.279cm; TEXT-ALIGN: justify" ms_positioning="FlowLayout">
					<b><u>PREAMBLE</u></b><br/>
					<br/>
					...
					and/or replacements that may be required under this Service Contract. <b>It is
					not intended that this Service Contract is an insurance policy.</b>
					<br/>
					<br/>
					<br/>
					<b><u>PERIOD OF COVER</u></b><br/>
					<br/>
					The Service Contract extends Unicomer's initial warranty for a further 2 years
					on furniture and electrical products. This means that inclusive of <b>Unicomer's</b>
					initial warranty period, your product will be covered for a total of 3 years
					<b>or any other period agreed between the insurance provider and Unicomer on your
					behalf</b> starting on the date of delivery.
					Coverage is conditional on you paying the applicable fee starting on the date
					of delivery.
					<br/>
					<br/>
					<br/>
					<b><u>WHAT WE COVER</u></b><br/>
					<br/>
					...
					<br/>
					This contract may only be purchased within 90 days of delivery <b>or any other period agreed
					between the insurance provider and Unicomer</b> of a covered product and is only valid if:<br/>
					<br/>
					<UL>
						<LI>
							<DIV style="MARGIN-LEFT: -20px">The product is purchased new from us and has a 
								<b>Unicomer</b> initial warranty
							</DIV>
						</LI>
						<LI>
				...
				<DIV class="smallPrint" style="LEFT: 10cm; WIDTH: 8.5cm; POSITION: absolute; TOP: 1.5cm; HEIGHT: 18.737cm; TEXT-ALIGN: justify" ms_positioning="FlowLayout">
					<ul>
						<LI>
					...
					<b><u>
						<br/>
						IN THE EVENT OF A BREAKDOWN</u></b>
					<ul>
						<LI>
						...
						<LI>
							<DIV style="MARGIN-LEFT: -20px">Contact your local Unicomer Store, or call 
								876-978-2592 for assistance. You will be told how to proceed with the repair.
							</DIV>
						</LI>
						<LI>
					...
					<br/>
					<br/>
          If we replace it, the original product becomes our property and <b>this service</b>
          contract terminates with no refund of fees.
          <br/>
					<br/>
					We are not responsible for any consequential or incidental damages arising from 
					the use or loss of use of the product.
					<br/>
					<br/>
					...
					<br/>
					<br/>
          FOR CLAIMS AND INQUIRIES CALL YOUR LOCAL ASHLEY HOME STORE OR PHONE 876-978-2592
          <br/>
					<br/>
					<b>Unicomer (<xsl:value-of select="COUNTRYNAME" />) Limited</b> offer this contract <b>on behalf 
					of the insurance provider</b>. We reserve the right to amend the terms and conditions.
				</DIV>
			</div>
