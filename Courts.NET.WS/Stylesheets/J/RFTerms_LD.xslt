...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="RFTERMS">
		<div class="RFHead1" align="center">
			<u>Lucky Credit - Terms &amp; Conditions</u>
			<br/>
			<br/>
		</div>
		<div style="LEFT: 0.3cm; WIDTH: 3cm; POSITION: absolute; HEIGHT: 1cm"><IMG style="HEIGHT: 50px" src="Stylesheets/J/smallLDLogo_RFTerms.png"/>
		</div>
		<div class="smallSS" style="LEFT: 0.5cm; POSITION: absolute; TOP: 3.5cm">This agreement explains 
			the terms of our Lucky Credit plan and governs its use at all times. In this 
			agreement the word “you” and “your” refer to each and all of the persons who 
			use a Lucky Credit card issued by us, under an account that we hold. The word 
			“we”, “us” and “our” means Unicomer (Jamaica) Limited (Unicomer).
			<br/>
		...
		<div class="smallSS" style="LEFT: 1.5cm; WIDTH: 8cm; POSITION: absolute; TOP: 11cm; TEXT-ALIGN: justify"><b>Lucky Credit Card</b>
			<br/>
			The card remains the property of Unicomer (Jamaica) Limited.
			<br/>
			You may use the card to purchase goods at any Branch of Unicomer.
			<br/>
			<br/>
			<b>Account Structure</b>
			<br/>
            You will have one master Lucky Credit account with a spending limit.
            <br/>
			...
			<br/>
			All your transactions will be subject to the Hire Purchase Act and the Security Interest in Personal Property Act.
			<br/>
			<br/>
			<b>Payments</b>
			<br/>
            You will make one single payment on or before the agreed payment date each month
            to cover the monthly instalment on your Lucky Credit account.
            <br/>
		...
		<div class="smallSS" style="LEFT: 11.5cm; WIDTH: 8cm; POSITION: absolute; TOP: 11cm; TEXT-ALIGN: justify">Your 
			...
			<br/>
            If your account becomes more than 2 months overdue your Lucky Credit account
            ...
            your Lucky Credit card, this will result in the card being refused and the
            purchase denied.
            <br/>
			<br/>
