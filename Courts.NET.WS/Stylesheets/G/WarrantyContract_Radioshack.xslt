...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="CONTRACT">
		<div style="position:relative">
			...
			<DIV style="Z-INDEX: 139; LEFT: 6cm; WIDTH: 2.5cm; POSITION: absolute; TOP: 0cm; HEIGHT: 1cm"><IMG style="WIDTH: 225px; HEIGHT: 72px" height="110" alt="" src="radioshack.png" width="426" /></DIV>
