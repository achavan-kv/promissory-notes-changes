  ...
  <xsl:template match="PAGE">
    <div style="position:relative">
      ...
      <table>
        ...
        <tr>
          <td>To: Courts ( Grenada ) Limited (hereinafter referred to as the Lender)</td>
        </tr>
        <br/>
        <br/>
        <tr>
        ...
        <tr>
          <td>
            For value received the undersigned jointly and severally (if more than one), promise to pay Courts ( Grenada ) Limited, (the Company) the sum of <xsl:value-of select="../FOOTER/TOTAL" /> dollars, including interests payable by  installments as follows:
          </td>
        </tr>
        <br/>
        <br/>
        ...
        <tr>
          <td>
            <table width="100%">
              ...
              <tr>
                <td>Witness (on behalf of Courts ( Grenada ) Limited)</td>
                <td>Date</td>
              </tr>
            </table>
          </td>
