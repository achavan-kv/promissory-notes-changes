...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="PAGE">
    <div style="position:relative">
      <!-- Header -->
      <p class="header" style="font-family:Helvetica, font-size:16px;">UNICOMER (GUYANA) INC.</p>
      ...
      <p>
        BETWEEN UNICOMER (GUYANA) INC., a limited liability company and licensed moneylender whose registered office is Lots 25-26 Main Street, Georgetown, Guyana (hereinafter called "the Lender”), AND <xsl:value-of select="HEADER/NAME" /> <xsl:choose>
      ...
      <p>
        The Lender has agreed to lend, and the Borrower(s) has agreed to borrow, a loan of <xsl:value-of select="HEADER/LOANAMOUNTWORDS"/> (GYD$<xsl:value-of select="HEADER/LOANAMOUNT"/>) on the following terms and conditions.
      </p>
      ...
      <ol>
        <li>
          ...
          <ol>
            <li>
              Subject to the terms and conditions hereinafter contained the Lender agrees to lend to the Borrower(s) the sum of <xsl:value-of select="HEADER/LOANAMOUNTWORDS"/> (GYD$<xsl:value-of select="HEADER/LOANAMOUNT"/>) (hereinafter called “the Loan”).
            </li>
            <li>
              In consideration of the Loan, the Borrower(s) jointly and severally agrees to repay the Loan including interest as provided in <b>Clause 2</b> below and in the manner outlined in <b>Schedule I – Loan Summary</b> and <b>Schedule II – Schedule of Payments</b> attached hereto, together with any applicable fees stated herein or otherwise
            </li>
            <li>
              The attached <b>Schedule III – Fact Sheet</b> summarises the key terms of this Loan Agreement.
            </li>
          </ol>
        </li>
        ...
        <li>
          ...
          <ol>
            ...
            <li>
              All interest hereunder shall be calculated as simple interest at the aforesaid rate, per annum.
            </li>
          </ol>
        </li>
        ...
        <li>
          ...
          <P>
            The Loan will be unsecured, but the Lender shall have the right to call for a Promissory Note endorsed by the Borrower(s) to evidence the sum outstanding at the time of making this Loan Agreement.
          </P>
          ...
          <li>
            ...
            <ol>
              <li>
                The Loan principal shall be repaid together with any accrued and unpaid interest due thereon by <xsl:value-of select="../FOOTER/INSTALNOWORDS"/>(<xsl:value-of select="../FOOTER/INSTALNO"/>) equal monthly installments of <xsl:value-of select="../FOOTER/FIRSTINSTWORD" /> (GYD$<xsl:value-of select="../FOOTER/FIRSTINST" />) which shall include interest at the rate of <xsl:value-of select="../FOOTER/INTERESTRATE"/>. Each installment shall be due and payable on the [day] in each month for <xsl:value-of select="../FOOTER/INSTALNO" /> months commencing on the <xsl:value-of select="../FOOTER/INSTALTABLE/INSTALMENTDATE)[1]" />, as specifically set out in <b>Schedule II – Schedule of Payments</b> attached hereto.
              </li>
              <li>
          ...
          <li>
            ...
            <ol>
              <li>
                The Borrower(s) may, without penalty, make early payments, pay more than the amount of any scheduled installment, or repay the entire loan before the final payment is due.
              </li>
            </ol>
          </li>
          ...
          <li>
            <span class="section-title">Late Interest</span>
            <p>
              If an installment that is due is unpaid the Borrower(s) shall be liable to pay late interest at the applicable daily rate of <xsl:value-of select="../FOOTER/DAILYLATEINTEREST" />% of the outstanding amount, until settlement of said outstanding amount in full.
            </p>
            ...
            <li>
              ...
              <ol>
                <li>
                  If payments are not made on or before their due dates and the Loan falls into default the Borrower may be required to pay the entire unpaid principal balance and any accrued interest and fees at once. Notice to pay all the unpaid balance, interest and fees shall be forwarded to the Borrower(s)’ within ten (10) days of the default and in accordance with clause 11 below.
                </li>
                <li>
                  The Lender reserves the right to institute legal proceedings against the Borrower to recover fees and court costs if the Loan, any interest, and fees are referred to an attorney or collection agency or agent for collection, due to the Borrower(s)’ default.
                </li>
              </ol>
            </li>
            ...
            <p>
              In addition to the provisions made in Clause 3 hereof, the Borrower(s) shall be liable to pay the stamping and any other cost associated with perfecting this Loan Agreement, which shall be deducted from the interest in accordance with clause 2.3.
            </p>
            ...
            <li>
              ...
              <ol>
                ...
                <li>
                  The Lender, subject to Section 22 of the Moneylenders Act Chap. 91:05, may at any time assign, sell, or otherwise transfer all or any of its rights and obligations under this Agreement or other related document and the Borrower(s) shall enter into all documents specified by the Lender to be necessary to give effect to any such assignment or transfer.
                </li>
              </ol>
            </li>
            ...
            <li>
              ...
              <ol>
                <li>
                  This Agreement shall be governed by and construed in accordance with the laws of the Co-operative Republic of Guyana.
                </li>
                <li>
                ...
                <li>
                  ...
                  <P>
                    Notice shall be mailed by registered post to the last known address on record of the principal Borrower(s).</p>
                  </li>
              </ol>
            </li>
            ...
            <!-- SCHEDULE I -->
            <p class="section-title" style="text-align:center;">SCHEDULE I - LOAN SUMMARY</p>
            <table width="100%">
              <tr>
                <td>
            ...
            <!-- SCHEDULE II -->
            <p class="section-title" style="text-align:center;">SCHEDULE II - SCHEDULE OF PAYMENTS</p>
            <xsl:choose>
            ...
            <!-- SCHEDULE III -->
            <p class="section-title" style="text-align:center;">SCHEDULE III – FACT SHEET: KEY TERMS OF THE LOAN AGREEMENT</p>
            <table width="100%">
              <tr>
                <th>Clause</th>
                <th>Description</th>
              ...
              <tr>
                ...
                <td>Loan Amount</td>
                <td>
                  GYD$<xsl:value-of select="HEADER/LOANAMOUNT"/>
                </td>
              </tr>
              <tr>
                <td>2</td>
                ...
                <td>
                  ...
                  Calculated as simple interest at the aforesaid rate, per annum.
                </td>
              </tr>
              <tr>
                <td>3</td>
                <td>Security</td>
                <td>
                  3.1. The Loan will be unsecured (Promissory Note to evidence the sum outstanding at any time).
                  3.2. Borrower to pay stamping and any other cost associated with perfecting the Promissory Note (Deducted from the interest).
                </td>
              </tr>
              <tr>
                <td>4</td>
                ...
                <td>
                  ...
                  <p>
                    Monthly installments – GYD$<xsl:value-of select="../FOOTER/FIRSTINST" />
                  </p>
                  <p>
              ...
              <tr>
                ...
                <td>
                  6.1. Default: Notice for complete and full payment of unpaid principal balance and any accrued interest to last known address within ten (10) days of the default.

                  6.2. Legal proceedings against Borrower to recover fees and court costs accumulated for procuring attorney/collection agent.
                </td>
              </tr>
              <tr>
                <td>7</td>
                <td>Stamping Fees</td>
                <td>Stamping fees and any other cost for perfecting the Loan Agreement (To be deducted from the interest).</td>
              </tr>
            </table>
