...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="PAGE">
		<div style="position:relative">
			...
			<div class="smallSS" style="LEFT: 148px; WIDTH: 172px; POSITION: absolute; TOP: 67px; HEIGHT: 25px"><i>
        Unicomer(St.Kitts&amp;-Nevis)Ltd</i>        
			</div>
			...
			<div class="smallSS" style="LEFT: 1px; WIDTH: 718px; POSITION: absolute; TOP: 138px; HEIGHT: 31px">
				This agreement sets out the terms on which <b>Unicomer(St.Kitts-Nevis)Ltd</b> whose registered office is at Bay Road, <b>("Courts")</b>
			...
			<div class="SmallPrint" style="LEFT: 36px; WIDTH: 293px; POSITION: absolute; TOP: 878px; HEIGHT: 99px" align="justify" id="Div3" language="javascript" onclick="return DIV1_onclick()">
				...
				Courts store on the islands of St.Kitts and Nevis.
				<br />
				<br />
			...
			<div style="position:relative">
				<div class="SmallPrint" style="LEFT: 1cm; WIDTH: 8.2cm; POSITION: absolute; TOP: 0.25cm; HEIGHT: 18cm" align="justify">
					...
					either 0.1%, 0.2% or 0.3 of the Agreement Price to purchase a Consumer Protection 
					...
					you with insurance in the event of your death. In the case of Courts Options Silver,
					Gold and Ultimate, the Insurance Policy is also designed to provide you with 
					insurance in the event of total disablement following an accident or sickness or the
					goods being destroyed or lost as a result of fire, flood of hurricane. Additionally,
					in the case of Courts Options Gold and Ultimate, the Insurance Policy is designed to
					provide you with insurance in the event that Goods are lost as a result of burglary
					of ur home. In the case of Courts Options Ultimate the Insurance Policy is designed
					to provide you with 25% of the original cash price back in Courts Cash if your Goods
					are damage by fire, flood or storm in the 24 months following the date that you
					...
					below, will release your obligations to make further payments under this Agreement.
					<br />
					In addition to the circumstances set out in Clause 5.3 above, if you have purchase 
					the Goods using Courts Options Gold or Ultimate, up to six of the monthly payments
					due under this Agreement will be met by Insurers and paid to Courts on your behalf 
					...
					Goods or your death, and you will remain liable to pay all such outstanding sums. 
					Under the terms of the Insurance Policy (a copy of which is available on 
					request) all sums are paid directly to Courts and not to you.
					<br />
					<br />
          ...
          incomplete information when applying to enter into this Agreement, including,
          ...
          its possession about Me/Us with any of its subsidiaries, agents, third party assignees, 
          other financial institutions, Credit Bureaus or other person of Corporation/s or with whom 
          I/We may have or propose to have financial dealings from time to time. I/We indemnify Unicomer 
          against any loss, claims, damages, liabilities, actions and proceedings, legal and or other 
          expense which may be directly and reasonably incurred as a consequence of the disclosure 
          of the financial or other information.
          <br />
					<br />
					<br />
					<br />
          ...
          6.4
				...
				<div class="SmallPrint" style="LEFT: 9.9cm; WIDTH: 9cm; POSITION: absolute; TOP: 7.41cm; HEIGHT: 18cm" align="justify">
