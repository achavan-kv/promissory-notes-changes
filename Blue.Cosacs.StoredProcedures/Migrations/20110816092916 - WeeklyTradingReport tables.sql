...
CREATE TABLE [dbo].[WTRReport](
	...
	[Product Category] [nvarchar](64) NOT NULL,
	[Branchno] [int] NULL,
	[BranchName] [varchar](20) NULL,
	[SalesType] [varchar](11) NULL,
...
-- Create table to hold column headings for Spreadsheet
	...
	'ProductCategory' as ProductCategory,'BranchNo' as Branchno,'BranchName' as BranchName,'SalesType' as SalesType,
