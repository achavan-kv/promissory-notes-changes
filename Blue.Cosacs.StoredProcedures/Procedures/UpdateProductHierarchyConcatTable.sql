...
IF EXISTS (SELECT * FROM SYSOBJECTS 
           WHERE NAME = 'UpdateProductHierarchyConcatTable'
           AND xtype = 'P')
BEGIN 
DROP PROCEDURE [Merchandising].[UpdateProductHierarchyConcatTable]
END
GO
...
-- Version:		<001> 
-- ========================================================================
CREATE PROCEDURE [Merchandising].[UpdateProductHierarchyConcatTable]
	
AS
BEGIN
DELETE FROM [Merchandising].[ProductHierarchyConcatTable]
