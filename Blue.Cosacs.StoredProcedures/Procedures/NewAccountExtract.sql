GO
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].NewAccountExtract') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].NewAccountExtract
GO

create proc NewAccountExtract
-- ================================================
-- Project      : CoSACS .NET
-- File Name    : NewAccountExtract.prc
-- File Type    : MSSQL Server Stored Procedure Script
-- Title        : New Account Extract
-- Author       : ??
-- Date         : ??
--
-- This procedure will retrieve New accounts for CLMS.
-- 
-- Change Control
-- --------------
-- Date      By  Description
...
SELECT 
	...
	REPLACE(CONVERT(CHAR(8), datedel, 3), '/', SPACE(0)) + '","' +
...
WHERE 
	...
	and datedel > @datestart and  datedel <= @datefinish
ORDER BY 1
