if exists (select * from dbo.sysobjects where id = object_id('[dbo].[FTP_ScorexApp]') 
            and OBJECTPROPERTY(id, 'IsProcedure') = 1)

Drop Procedure FTP_ScorexApp
go

Create Procedure FTP_ScorexApp

-- Author: John Croft based on [Andrew Zanevsky, 21st Sentry, Inc. (www.pinnaclepublishing.com)]
-- Procedure to FTP Scorex Application data
...
insert #ftp_script values ( 'put d:\users\default\ScorexApp.csv ScorexApp_' + @Country + '.csv' )
