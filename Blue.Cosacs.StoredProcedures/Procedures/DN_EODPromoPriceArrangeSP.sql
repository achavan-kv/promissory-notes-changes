...
if exists (select * from dbo.sysobjects where id = object_id('[dbo].[DN_EODPromoPriceArrangeSP]') and OBJECTPROPERTY(id, 'IsProcedure') = 1)
drop procedure [dbo].[DN_EODPromoPriceArrangeSP]
GO

CREATE PROCEDURE DN_EODPromoPriceArrangeSP
